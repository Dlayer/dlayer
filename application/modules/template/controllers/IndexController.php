...
* @version $Id: IndexController.php 1515 2014-02-01 23:15:22Z Dean.Blackborough $
*/
class Template_IndexController extends Zend_Controller_Action
{
    ...
    */
    private function dlayerMenu($url) 
    {
        ...
        'children'=>array(array('url'=>'/content/index/index', 
    ...
    */
    public function newTemplateAction() 
    {
        ...
        $this->layout->assign('title', 'Dlayer.com - New template');
    ...
    */
    ...
    {
    	$this->layout->assign('css_include', array('styles/forms.css'));
        $this->layout->assign('title', 'Dlayer.com - Edit template');
