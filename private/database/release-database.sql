...
insert  into `dlayer_identity`(`id`,`identity`,`credentials`,`logged_in`,`last_login`,`last_action`,`enabled`) values (1,'user-1@dlayer.com','$6$rounds=5000$jks453yuyt55d$CZJCjaieFQghQ6MwQ1OUI5nVKDy/Fi2YXk7MyW2hcex9AdJ/jvZA8ulvjzK1lo3rRVFfmd10lgjqAbDQM4ehR1',0,'2015-02-10 14:13:49','2015-02-10 16:25:20',1),(2,'user-2@dlayer.com','$6$rounds=5000$jks453yuyt55d$ZVEJgs2kNjxOxNEayqqoh2oJUiGbmxIKRqOTxVM05MP2YRcAjE9adCZfQBWCc.qe1nDjEM9.ioivNz3c/qyZ80',0,'2015-02-04 15:36:42','2015-02-04 15:37:10',1),(3,'user-3@dlayer.com','$6$rounds=5000$jks453yuyt55d$NYF6yCvxXplefx7nr8vDe4cUGBEFtd3G5vuJ2utfqvPwEf3dSgNXNTcGbFO6WrJSn21CXHgZwNOQHy691E/Rm.',0,'2015-02-03 15:48:38','2015-02-03 15:49:03',1);
...
insert  into `user_site_content_heading`(`id`,`site_id`,`name`,`content`) values (1,1,'H1 Test heading','This is a test page title heading'),(2,1,'H2 Test heading','This is a test H2 heading');
...
insert  into `user_site_page_content_item`(`id`,`site_id`,`page_id`,`row_id`,`content_type`,`sort_order`) values (1,1,1,1,2,1),(2,1,1,1,2,2),(3,1,1,3,2,1),(4,1,1,2,1,1),(5,1,1,3,3,2);
...
insert  into `user_site_page_content_rows`(`id`,`site_id`,`page_id`,`div_id`,`sort_order`) values (1,1,1,2,1),(2,1,1,2,2),(3,1,1,3,1);
