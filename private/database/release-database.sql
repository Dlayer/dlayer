...
insert  into `user_site_page_content_item_size`(`id`,`site_id`,`page_id`,`content_id`,`size`,`offset`) values (1,1,1,4,6,0),(2,1,1,5,6,0),(3,2,2,9,6,0),(4,2,2,10,6,0),(5,3,3,14,6,0),(6,3,3,15,6,0),(7,1,1,1,12,0),(8,1,1,3,9,3);
