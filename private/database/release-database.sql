...
insert  into `designer_content_type`(`id`,`name`,`description`,`tool_id`) values (1,'text','Text block',10),(2,'heading','Heading',11),(3,'form','Form',16),(4,'jumbotron','Jumbotron',34),(5,'image','Image',39);
...
insert  into `designer_css_text_weight`(`id`,`name`,`css`,`sort_order`) values (1,'Normal','400',1),(2,'Bold','700',3),(3,'Light','100',4),(4,'Light bold','500',2);
...
insert  into `designer_form_field_attribute`(`id`,`field_type_id`,`name`,`attribute`,`attribute_type_id`) values (1,1,'Size','size',1),(2,1,'Max length','maxlength',1),(3,2,'Columns','cols',1),(4,2,'Rows','rows',1),(5,3,'Size','size',1),(6,3,'Max length','maxlength',1),(7,1,'Placeholder','placeholder',2),(8,2,'Placeholder','placeholder',2),(9,3,'Placeholder','placeholder',2),(10,4,'Size','size',1),(11,4,'Max length','maxlength',1),(12,4,'Placeholder','placeholder',2);
...
insert  into `designer_form_field_param_preview`(`id`,`field_type_id`,`field_attribute_id`,`preview_method_id`) values (1,1,1,3),(2,1,2,3),(3,1,7,1),(4,2,3,3),(5,2,4,3),(6,2,8,1),(7,3,5,3),(8,3,6,3),(9,3,9,1),(10,4,10,3),(11,4,11,3),(12,4,12,1);
...
insert  into `designer_form_field_type`(`id`,`name`,`type`,`description`) values (1,'Text','text','A single line field'),(2,'Textarea','textarea','A multiple line field'),(3,'Password','password','A password field'),(4,'Email','email','Email field');
...
insert  into `designer_form_layout`(`id`,`layout`,`class`) values (1,'Standard','form'),(2,'Inline','form-inline'),(3,'Horizontal','form-horizontal');
...
insert  into `dlayer_glyphicon`(`id`,`name`,`glyphicon`) values (1,'None',''),(2,'Add/Edit','glyphicon glyphicon-pencil'),(3,'Size and position','glyphicon glyphicon-resize-horizontal'),(4,'Styles','glyphicon glyphicon-adjust'),(5,'Help','glyphicon glyphicon-question-sign'),(6,'Go to designer','glyphicon glyphicon-new-window'),(7,'Move','glyphicon glyphicon-move'),(8,'Select','glyphicon glyphicon-hand-up'),(9,'Information','glyphicon glyphicon-info-sign');
...
insert  into `dlayer_identity`(`id`,`identity`,`credentials`,`logged_in`,`last_login`,`last_action`,`enabled`) values (1,'user-1@dlayer.com','$6$rounds=5000$jks453yuyt55d$CZJCjaieFQghQ6MwQ1OUI5nVKDy/Fi2YXk7MyW2hcex9AdJ/jvZA8ulvjzK1lo3rRVFfmd10lgjqAbDQM4ehR1',0,'2015-07-01 12:10:37','2015-07-01 12:46:39',1),(2,'user-2@dlayer.com','$6$rounds=5000$jks453yuyt55d$ZVEJgs2kNjxOxNEayqqoh2oJUiGbmxIKRqOTxVM05MP2YRcAjE9adCZfQBWCc.qe1nDjEM9.ioivNz3c/qyZ80',0,'2015-05-29 15:57:54','2015-05-29 15:58:47',1),(3,'user-3@dlayer.com','$6$rounds=5000$jks453yuyt55d$NYF6yCvxXplefx7nr8vDe4cUGBEFtd3G5vuJ2utfqvPwEf3dSgNXNTcGbFO6WrJSn21CXHgZwNOQHy691E/Rm.',0,'2015-05-29 15:59:10','2015-05-29 16:25:10',1);
...
insert  into `dlayer_module`(`id`,`name`,`title`,`description`,`sort_order`,`enabled`) values (1,'template','Template designer','Design new templates and tweak existing ones. <span class=\"label label-warning\">Development on hold</span>',7,1),(2,'widget','Widget designer','Design new widgets and tweak existing ones. <span class=\"label label-default\">Development planning</span>',4,1),(3,'form','Form builder','Create new forms, manage existing forms and submissions. <span class=\"label label-success\">Active development</span>',2,1),(4,'content','Content manager','Create new content pages and manage existing ones. <span class=\"label label-success\">Active development</span>',1,1),(5,'website','Web site manager','Organise your web site. <span class=\"label label-info\">Design preview</span>',5,1),(6,'question','Question manager','Create quizzes, tests and polls. <span class=\"label label-default\">Planning</span>',99,0),(7,'dlayer','Dlayer','Home',0,1),(8,'image','Image library','Manage your media library. <span class=\"label label-warning\">Development on hold</span>',6,1),(9,'data','Data manager','Create your datasets and manage your data. <span class=\"label label-info\">Design preview in development</span>',3,1);
...
insert  into `dlayer_module_tool`(`id`,`module_id`,`name`,`tool`,`tool_model`,`folder`,`base`,`destructive`,`group_id`,`sort_order`,`enabled`) values (1,1,'Cancel','cancel',NULL,'cancel',1,0,1,1,1),(2,1,'Create rows','split-horizontal','SplitHorizontal','split-horizontal',1,1,2,1,1),(3,1,'Split vertical','split-vertical','SplitVertical','split-vertical',1,1,2,2,0),(6,1,'Resize','resize','Resize','resize',0,1,2,3,0),(7,1,'Background colour','background-color','BackgroundColor','background-color',1,0,3,1,0),(8,1,'Border','border','Border','border',1,0,3,2,0),(9,4,'Cancel','cancel',NULL,'cancel',2,0,1,1,1),(10,4,'Text','text','Text','text',0,0,3,2,1),(11,4,'Heading','heading','Heading','heading',0,0,3,1,1),(12,3,'Text','text','Text','text',0,0,4,1,1),(13,3,'Text area','textarea','Textarea','textarea',0,0,4,2,1),(14,3,'Cancel','cancel',NULL,'cancel',2,0,1,1,1),(15,3,'Password','password','Password','password',0,0,4,4,1),(16,4,'Form','import-form','ImportForm','import-form',0,0,3,4,1),(17,5,'Cancel','cancel',NULL,'cancel',0,0,1,1,1),(18,5,'New page','new-page','NewPage','new-page',0,0,2,2,1),(19,5,'Move page','move-page','MovePage','move-page',0,0,2,1,1),(20,3,'Email','preset-email','Email','preset-email',0,0,3,2,1),(21,3,'Name','preset-name','Text','preset-name',0,0,3,1,1),(22,4,'Text','import-text','ImportText','import-text',0,0,4,2,1),(23,4,'Heading','import-heading','ImportHeading','import-heading',0,0,4,3,1),(25,8,'Add to library','add','Add','add',1,0,2,1,1),(26,8,'Cancel / Back to library','cancel',NULL,'cancel',0,0,1,1,1),(27,8,'Category','category','Category','category',1,0,2,2,1),(28,8,'Sub category','subcategory','Subcategory','subcategory',1,0,2,3,1),(29,8,'Clone','copy','Copy','copy',0,0,3,2,1),(30,8,'Crop','crop','Crop','crop',0,0,4,1,1),(31,8,'Edit','edit','Edit','edit',0,0,3,1,1),(32,4,'Add content row(s)','add-content-row','AddContentRow','add-content-row',1,0,2,3,1),(34,4,'Jumbotron','jumbotron','Jumbotron','jumbotron',0,0,3,3,1),(35,4,'Jumbotron','import-jumbotron','ImportJumbotron','import-jumbotron',0,0,4,4,1),(36,4,'Move row','move-row','MoveRow','move-row',1,0,2,5,1),(37,4,'Move item','move-item','MoveItem','move-item',1,0,2,6,1),(38,4,'Content row','content-row','ContentRow','content-row',1,0,2,4,1),(39,4,'Image','image','Image','image',0,0,3,5,1),(40,4,'Carousel','carousel','ImageCarousel','carousel',0,0,3,6,0),(41,4,'Select parent','select','Select','select',1,0,2,1,1),(42,3,'Layout','form-layout','FormLayout','form-layout',1,0,2,1,1),(43,3,'Actions','form-actions','formActions','form-actions',1,0,2,2,1),(44,3,'Settings','form-settings','FormSettings','form-settings',1,0,2,3,1),(45,3,'Email','email','Email','email',0,0,4,3,1),(46,4,'Content area','content-area','ContentArea','content-area',1,0,2,2,1),(47,3,'Comment','preset-comment','Textarea','preset-comment',0,0,3,3,1),(48,3,'Password','preset-password','Password','preset-password',0,0,3,4,1);
...
insert  into `dlayer_module_tool_tab`(`id`,`module_id`,`tool_id`,`name`,`glyphicon_id`,`view_script`,`sub_tool_model`,`multi_use`,`edit_mode`,`default`,`sort_order`,`enabled`) values (1,1,2,'Quick',1,'quick',NULL,0,0,1,1,1),(2,1,2,'Custom',1,'advanced',NULL,0,0,0,2,1),(3,1,2,'?',1,'help',NULL,0,0,0,3,1),(4,1,3,'Quick',1,'quick',NULL,0,0,1,1,1),(5,1,3,'Mouse',1,'advanced',NULL,0,0,0,2,1),(6,1,3,'?',1,'help',NULL,0,0,0,3,1),(7,1,7,'#1',1,'palette-1',NULL,0,0,1,1,1),(8,1,7,'#2',1,'palette-2',NULL,0,0,0,2,1),(9,1,7,'#3',1,'palette-3',NULL,0,0,0,3,1),(10,1,7,'Custom',1,'advanced',NULL,0,0,0,4,1),(11,1,7,'?',1,'help',NULL,0,0,0,5,1),(12,1,6,'Custom',1,'advanced',NULL,0,0,0,4,1),(14,1,6,'?',1,'help',NULL,0,0,0,5,1),(15,1,6,'Push',1,'expand',NULL,0,0,1,1,1),(16,1,6,'Pull',1,'contract',NULL,0,0,0,2,1),(17,1,6,'Height',1,'height',NULL,0,0,0,3,1),(20,1,8,'Custom',1,'advanced',NULL,0,0,0,2,1),(21,1,8,'?',1,'help',NULL,0,0,0,3,1),(22,1,8,'Full border',1,'full',NULL,0,0,1,1,1),(23,4,10,'Text',2,'text',NULL,1,0,1,1,1),(24,4,11,'Heading',2,'heading',NULL,1,0,1,1,1),(25,4,10,'Help',5,'help',NULL,0,0,0,4,1),(26,4,11,'Help',5,'help',NULL,0,0,0,4,1),(27,3,12,'Text field',2,'text',NULL,1,0,1,1,1),(28,3,12,'Help',5,'help',NULL,0,0,0,3,1),(29,3,13,'Text area field',2,'textarea',NULL,1,0,1,1,1),(30,3,13,'Help',5,'help',NULL,0,0,0,3,1),(31,3,15,'Password field',2,'password',NULL,1,0,1,1,1),(32,3,15,'Help',5,'help',NULL,0,0,0,3,1),(33,4,16,'Form',2,'import-form',NULL,1,0,1,1,1),(34,4,16,'Help',5,'help',NULL,0,0,0,5,1),(35,5,18,'Page',1,'new-page',NULL,0,0,1,1,1),(36,5,18,'?',1,'help',NULL,0,0,0,2,1),(37,5,19,'Page',1,'move-page',NULL,0,0,1,1,1),(38,5,19,'?',1,'help',NULL,0,0,0,2,1),(39,4,10,'Styles',4,'styling','Styling_Text',1,1,0,3,1),(40,4,11,'Styles',4,'styling','Styling_Heading',1,1,0,3,1),(41,4,16,'Styles',4,'styling','Styling_ImportForm',1,1,0,4,1),(42,3,20,'Email field',2,'preset-email',NULL,0,0,1,1,1),(43,3,20,'Help',5,'help',NULL,0,0,0,3,1),(44,3,21,'Name field',2,'preset-name',NULL,0,0,1,1,1),(45,3,21,'Help',5,'help',NULL,0,0,0,3,1),(46,4,16,'Size & position',3,'position','Position_ImportForm',1,1,0,3,1),(47,4,10,'Size & position',3,'position','Position_Text',1,1,0,2,1),(48,4,11,'Size & position',3,'position','Position_Heading',1,1,0,2,1),(49,3,12,'Styling',4,'styling','Styling_Text',1,1,0,2,1),(50,3,13,'Styling',4,'styling','Styling_Textarea',1,1,0,2,1),(51,3,15,'Styling',4,'styling','Styling_Password',1,1,0,2,1),(54,4,16,'Edit in Form builder',6,'edit',NULL,0,1,0,2,1),(55,4,22,'Import',2,'import-text',NULL,1,0,1,1,1),(56,4,22,'Help',5,'help',NULL,0,0,0,2,1),(57,4,23,'Import',2,'import-heading',NULL,1,0,1,1,1),(58,4,23,'Help',5,'help',NULL,0,0,2,2,1),(61,8,25,'Image',1,'add',NULL,0,0,1,1,1),(62,8,25,'?',1,'help',NULL,0,0,0,2,1),(63,8,27,'Category',1,'category',NULL,0,0,1,1,1),(64,8,27,'?',1,'help',NULL,0,0,0,2,1),(65,8,28,'Sub category',1,'subcategory',NULL,0,0,1,1,1),(66,8,28,'?',1,'help',NULL,0,0,0,2,1),(67,8,29,'Clone',1,'copy',NULL,0,0,1,1,1),(68,8,29,'?',1,'help',NULL,0,0,0,2,1),(69,8,30,'?',1,'help',NULL,0,0,0,2,1),(70,8,31,'Edit',1,'edit',NULL,0,0,1,1,1),(71,8,31,'?',1,'help',NULL,0,0,0,2,1),(72,8,30,'Crop',1,'crop',NULL,0,0,1,1,1),(73,4,32,'Row',2,'add-content-row',NULL,0,0,1,1,1),(74,4,32,'Help',5,'help',NULL,0,0,0,2,1),(77,4,34,'Jumbotron',2,'jumbotron',NULL,1,0,1,1,1),(78,4,34,'Help',5,'help',NULL,0,0,0,4,1),(79,4,34,'Styles',4,'styling','Styling_Jumbotron',1,1,0,3,1),(80,4,34,'Size & position',3,'position','Position_Jumbotron',1,1,0,2,1),(81,4,35,'Import',2,'import-jumbotron',NULL,1,0,1,1,1),(82,4,35,'Help',5,'help',NULL,0,0,0,2,1),(83,4,36,'Move',7,'move-row',NULL,1,0,1,1,1),(84,4,36,'Help',5,'help',NULL,0,0,0,2,1),(85,4,37,'Move',7,'move-item',NULL,1,0,1,1,1),(86,4,37,'Help',5,'help',NULL,0,0,0,2,1),(87,4,38,'Row',9,'content-row',NULL,0,0,1,1,1),(88,4,38,'Styles',4,'styling','Styling_ContentRow',0,0,0,2,1),(89,4,39,'Image',2,'image',NULL,1,0,1,1,1),(90,4,39,'Help',5,'help',NULL,0,0,0,4,1),(91,4,40,'Carousel',2,'carousel',NULL,1,0,1,1,1),(92,4,40,'Help',5,'help',NULL,0,0,0,2,1),(93,4,39,'Size & position',3,'position','Position_Image',1,1,0,2,1),(94,4,39,'Styles',4,'styling','Styling_Image',1,1,0,3,1),(95,4,41,'Select',8,'select',NULL,0,0,1,1,1),(96,4,41,'Help',5,'help',NULL,0,0,0,2,1),(97,3,42,'Form layout',2,'form-layout',NULL,1,0,1,1,1),(98,3,42,'Help',5,'help',NULL,0,0,0,2,1),(99,3,45,'Email field',2,'email',NULL,1,0,1,1,1),(100,3,45,'Help',5,'help',NULL,0,0,0,3,1),(101,3,45,'Styling',4,'styling','Styling_Email',1,1,0,2,1),(102,3,43,'Form actions',2,'form-actions',NULL,1,0,1,1,1),(103,3,43,'Help',5,'help',NULL,0,0,0,2,1),(104,3,44,'Form settings',2,'form-settings',NULL,1,0,1,1,1),(105,3,44,'Help',5,'help',NULL,0,0,0,2,1),(106,4,38,'Help',5,'help',NULL,0,0,0,3,1),(107,4,46,'Area',9,'content-area',NULL,0,0,1,1,1),(108,4,46,'Styles',4,'styling','Styling_ContentArea',0,0,0,2,1),(109,4,46,'Help',5,'help',NULL,0,0,0,3,1),(110,3,47,'Comment field',2,'preset-comment',NULL,0,0,1,1,1),(111,3,47,'Help',5,'help',NULL,0,0,0,2,1),(112,3,48,'Password field',2,'preset-password',NULL,0,0,1,1,1),(113,3,48,'Help',5,'help',NULL,0,0,0,2,1);
...
insert  into `dlayer_session`(`session_id`,`save_path`,`name`,`modified`,`lifetime`,`session_data`) values ('3nkbid5q3h6osm743hqiufucc5','','PHPSESSID',1434640761,3601,'__ZF|a:6:{s:14:\"dlayer_session\";a:1:{s:3:\"ENT\";i:1434644361;}s:22:\"dlayer_session_content\";a:1:{s:3:\"ENT\";i:1434644361;}s:23:\"dlayer_session_designer\";a:1:{s:3:\"ENT\";i:1434644361;}s:23:\"dlayer_session_template\";a:1:{s:3:\"ENT\";i:1434644361;}s:19:\"dlayer_session_form\";a:1:{s:3:\"ENT\";i:1434644361;}s:20:\"dlayer_session_image\";a:1:{s:3:\"ENT\";i:1434644361;}}dlayer_session_content|a:7:{s:7:\"page_id\";N;s:6:\"div_id\";N;s:14:\"content_row_id\";N;s:10:\"content_id\";N;s:4:\"tool\";N;s:3:\"tab\";N;s:11:\"template_id\";N;}dlayer_session_template|a:4:{s:6:\"div_id\";N;s:4:\"tool\";N;s:3:\"tab\";N;s:11:\"template_id\";N;}dlayer_session_form|a:5:{s:8:\"field_id\";N;s:4:\"tool\";N;s:3:\"tab\";N;s:7:\"form_id\";N;s:6:\"return\";N;}dlayer_session_designer|a:4:{s:24:\"image_picker_category_id\";N;s:28:\"image_picker_sub_category_id\";N;s:21:\"image_picker_image_id\";N;s:23:\"image_picker_version_id\";N;}dlayer_session_image|a:3:{s:4:\"tool\";N;s:3:\"tab\";N;s:9:\"image_ids\";a:0:{}}'),('4cg9007ovco6hp1b8o3g12lku5','','PHPSESSID',1435751204,3601,'__ZF|a:6:{s:23:\"dlayer_session_template\";a:1:{s:3:\"ENT\";i:1435754804;}s:19:\"dlayer_session_form\";a:1:{s:3:\"ENT\";i:1435754804;}s:22:\"dlayer_session_content\";a:1:{s:3:\"ENT\";i:1435754804;}s:20:\"dlayer_session_image\";a:1:{s:3:\"ENT\";i:1435754804;}s:23:\"dlayer_session_designer\";a:1:{s:3:\"ENT\";i:1435754804;}s:14:\"dlayer_session\";a:1:{s:3:\"ENT\";i:1435754804;}}dlayer_session_template|a:4:{s:6:\"div_id\";N;s:4:\"tool\";N;s:3:\"tab\";N;s:11:\"template_id\";N;}dlayer_session_form|a:5:{s:8:\"field_id\";N;s:4:\"tool\";N;s:3:\"tab\";N;s:7:\"form_id\";N;s:6:\"return\";N;}dlayer_session_content|a:7:{s:6:\"div_id\";N;s:14:\"content_row_id\";N;s:10:\"content_id\";N;s:4:\"tool\";N;s:3:\"tab\";N;s:7:\"page_id\";N;s:11:\"template_id\";N;}dlayer_session_designer|a:4:{s:24:\"image_picker_category_id\";N;s:28:\"image_picker_sub_category_id\";N;s:21:\"image_picker_image_id\";N;s:23:\"image_picker_version_id\";N;}dlayer_session_image|a:3:{s:4:\"tool\";N;s:3:\"tab\";N;s:9:\"image_ids\";a:0:{}}'),('8ct3gdu9e73fekuamot022t1q7','','PHPSESSID',1435073542,3601,'__ZF|a:1:{s:14:\"dlayer_session\";a:1:{s:3:\"ENT\";i:1435077142;}}'),('9b1q29pipbdd06j773oa39rrf3','','PHPSESSID',1434704277,3601,'__ZF|a:1:{s:14:\"dlayer_session\";a:1:{s:3:\"ENT\";i:1434707877;}}'),('dn2ddeqqpg5vm6c15gs71hq3q2','','PHPSESSID',1435069713,3601,'__ZF|a:1:{s:14:\"dlayer_session\";a:1:{s:3:\"ENT\";i:1435073313;}}'),('pbp8lf03r62ouros9dq04k2ls6','','PHPSESSID',1434704036,3601,'__ZF|a:1:{s:14:\"dlayer_session\";a:1:{s:3:\"ENT\";i:1434707635;}}');
...
insert  into `user_setting_font_family`(`id`,`site_id`,`module_id`,`font_family_id`) values (1,1,3,8),(2,1,4,1),(3,2,3,1),(4,2,4,1),(5,3,3,1),(6,3,4,1);
...
insert  into `user_setting_heading`(`id`,`site_id`,`heading_id`,`style_id`,`weight_id`,`decoration_id`,`size`,`color_hex`,`sort_order`) values (1,1,1,1,4,1,36,'#000000',1),(2,1,2,1,4,1,30,'#000000',2),(3,1,3,1,4,1,24,'#000000',3),(4,1,4,1,4,1,18,'#000000',4),(5,1,5,1,4,1,14,'#000000',5),(6,1,6,1,4,1,12,'#000000',6),(7,2,1,1,4,1,36,'#000000',1),(8,2,2,1,4,1,30,'#000000',2),(9,2,3,1,4,1,24,'#000000',3),(10,2,4,1,4,1,18,'#000000',4),(11,2,5,1,4,1,14,'#000000',5),(12,2,6,1,4,1,12,'#000000',6),(13,3,1,1,4,1,36,'#000000',1),(14,3,2,1,4,1,30,'#000000',2),(15,3,3,1,4,1,24,'#000000',3),(16,3,4,1,4,1,18,'#000000',4),(17,3,5,1,4,1,14,'#000000',5),(18,3,6,1,4,1,12,'#000000',6);
...
insert  into `user_site_form`(`id`,`site_id`,`name`,`email`) values (1,1,'Contact form','email@email.com'),(2,1,'Subscribe','email@email.com'),(3,2,'Contact form','email@email.com'),(4,2,'Subscribe','email@email.com'),(5,3,'Contact form','email@email.com'),(6,3,'Subscribe','email@email.com');
...
insert  into `user_site_form_field`(`id`,`site_id`,`form_id`,`field_type_id`,`tool_id`,`label`,`description`,`sort_order`) values (1,1,1,1,12,'Your name','Please enter your name',2),(2,1,1,4,45,'Your email','Please enter your email address',1),(3,1,1,2,13,'Comment','Please enter your comment',3),(4,1,2,1,12,'Your name','Please enter your name',1),(5,1,2,4,45,'Your email','Please enter your email address',2),(6,2,3,1,12,'Your name','Please enter your name',1),(7,2,3,4,45,'Your email','Please enter your email address',2),(8,2,3,2,13,'Comment','Please enter your comment',3),(9,2,4,1,12,'Your name','Please enter your name',1),(10,2,4,4,45,'Your email','Please enter your email address',2),(11,3,5,1,12,'Your name','Please enter your name',1),(12,3,5,4,45,'Your email','Please enter your email address',2),(13,3,5,2,13,'Comment','Please enter your comment',3),(14,3,6,1,12,'Your name','Please enter your name',1),(15,3,6,4,45,'Your email','Please enter your email address',2);
...
insert  into `user_site_form_field_row_background_color`(`id`,`site_id`,`form_id`,`field_id`,`color_hex`) values (2,1,1,2,'#eeeeee'),(4,1,2,4,'#eeeeee');
...
insert  into `user_site_form_layout`(`id`,`site_id`,`form_id`,`title`,`sub_title`,`submit_label`,`reset_label`,`layout_id`,`horizontal_width_label`,`horizontal_width_field`) values (1,1,2,'Subscribe','Enter your details to be added to the subscription list','Subscribe','',3,2,10),(2,1,1,'Contact','Complete the form to contact us','Send','Reset',1,2,10),(3,2,4,'Subscribe','Subscribe to our newsletter','Subscribe','',3,2,10),(4,2,3,'Contact','Complete the form to contact us','Send','Reset',1,2,10),(5,3,6,'Subscribe','Subscribe to our newsletter','Subscribe','',3,2,10),(6,3,5,'Contact','Complete the form to contact us','Send','Reset',1,2,10);
...
insert  into `user_site_page_content_item_jumbotron`(`id`,`site_id`,`page_id`,`content_id`,`data_id`,`button_label`) values (1,1,1,1,1,'Useless button'),(2,2,2,6,2,'Useless button'),(3,3,3,11,3,'Useless button');
...
DROP TABLE IF EXISTS `user_site_page_styles_area_background_color`;
