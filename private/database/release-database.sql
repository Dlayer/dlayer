...
insert  into `designer_form_layout`(`id`,`layout`) values (1,'Standard'),(2,'Inline'),(3,'Horizontal');
...
insert  into `dlayer_identity`(`id`,`identity`,`credentials`,`logged_in`,`last_login`,`last_action`,`enabled`) values (1,'user-1@dlayer.com','$6$rounds=5000$jks453yuyt55d$CZJCjaieFQghQ6MwQ1OUI5nVKDy/Fi2YXk7MyW2hcex9AdJ/jvZA8ulvjzK1lo3rRVFfmd10lgjqAbDQM4ehR1',0,'2015-05-31 15:28:10','2015-05-31 17:18:07',1),(2,'user-2@dlayer.com','$6$rounds=5000$jks453yuyt55d$ZVEJgs2kNjxOxNEayqqoh2oJUiGbmxIKRqOTxVM05MP2YRcAjE9adCZfQBWCc.qe1nDjEM9.ioivNz3c/qyZ80',0,'2015-05-29 15:57:54','2015-05-29 15:58:47',1),(3,'user-3@dlayer.com','$6$rounds=5000$jks453yuyt55d$NYF6yCvxXplefx7nr8vDe4cUGBEFtd3G5vuJ2utfqvPwEf3dSgNXNTcGbFO6WrJSn21CXHgZwNOQHy691E/Rm.',0,'2015-05-29 15:59:10','2015-05-29 16:25:10',1);
...
CREATE TABLE `user_site_form_layout` (
  ...
  `horizontal_width_label` tinyint(2) unsigned NOT NULL DEFAULT '3',
  `horizontal_width_field` tinyint(2) unsigned NOT NULL DEFAULT '9',
  PRIMARY KEY (`id`),
  KEY `site_id` (`site_id`),
  KEY `form_id` (`form_id`),
...
insert  into `user_site_form_layout`(`id`,`site_id`,`form_id`,`title`,`sub_title`,`submit_label`,`reset_label`,`layout_id`,`horizontal_width_label`,`horizontal_width_field`) values (1,1,2,'Subscribe','Enter your details to be added to the subscription list','Subscribe','',1,3,9),(2,1,1,'Contact','Complete the form to contact us','Send','Reset',1,3,9),(3,2,4,'Subscribe','Subscribe to our newsletter','Subscribe','',1,3,9),(4,2,3,'Contact','Complete the form to contact us','Send','Reset',1,3,9),(5,3,6,'Subscribe','Subscribe to our newsletter','Subscribe','',1,3,9),(6,3,5,'Contact','Complete the form to contact us','Send','Reset',1,3,9);
