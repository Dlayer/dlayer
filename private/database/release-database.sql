...
insert  into `user_site_page_content_rows`(`id`,`site_id`,`page_id`,`div_id`,`sort_order`) values (1,1,1,2,1),(2,1,1,3,1),(3,2,2,6,1),(4,2,2,7,1),(5,3,3,10,1),(6,3,3,11,1);
