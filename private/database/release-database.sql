...
insert  into `dlayer_identity`(`id`,`identity`,`credentials`,`logged_in`,`last_login`,`last_action`,`enabled`) values (1,'user-1@dlayer.com','$6$rounds=5000$jks453yuyt55d$CZJCjaieFQghQ6MwQ1OUI5nVKDy/Fi2YXk7MyW2hcex9AdJ/jvZA8ulvjzK1lo3rRVFfmd10lgjqAbDQM4ehR1',0,'2015-04-21 15:40:21','2015-04-21 15:56:00',1),(2,'user-2@dlayer.com','$6$rounds=5000$jks453yuyt55d$ZVEJgs2kNjxOxNEayqqoh2oJUiGbmxIKRqOTxVM05MP2YRcAjE9adCZfQBWCc.qe1nDjEM9.ioivNz3c/qyZ80',0,'2015-03-31 11:36:10','2015-03-31 11:36:10',1),(3,'user-3@dlayer.com','$6$rounds=5000$jks453yuyt55d$NYF6yCvxXplefx7nr8vDe4cUGBEFtd3G5vuJ2utfqvPwEf3dSgNXNTcGbFO6WrJSn21CXHgZwNOQHy691E/Rm.',0,'2015-03-31 11:36:34','2015-03-31 11:36:34',1);
...
insert  into `dlayer_module`(`id`,`name`,`title`,`description`,`sort_order`,`enabled`) values (1,'template','Template designer','Create and manage the templates for your site. - (Some functionality)',6,1),(2,'widget','Widget designer','Create and manage your reusable and dynamic blocks. Using the widget designer you can create either static or dynamic reusable blocks. If there is an element or function that you need to appear on multiple pages it should probably be a widget.',1,0),(3,'form','Form builder','Create and manage the forms for your site. - (Some functionality)',3,1),(4,'content','Content manager','Create and manage the site content. - (Some functionality)',2,1),(5,'website','Web site manager','Manage site structure and site level widget data. - (Preview only)',5,1),(6,'question','Question manager','Create quizzes, tests and polls, system supports multiple pages, multiple questions types, for example text, image, video and multiple answer types, free text, multiple choice, true or false. Results are summed and calculated and can either be displayed or stored for just the administrator.',4,0),(7,'dlayer','Dlayer','Home',0,1),(8,'image','Image library','Manage all your images. - (Some functionality)',7,1),(9,'data','Data manager','Manage the data for your site, this will be the data that is consumed by widgets or forms.',8,0);
