...
insert  into `dlayer_identity`(`id`,`identity`,`credentials`,`logged_in`,`last_login`,`last_action`,`enabled`) values (1,'user-1@dlayer.com','$6$rounds=5000$jks453yuyt55d$CZJCjaieFQghQ6MwQ1OUI5nVKDy/Fi2YXk7MyW2hcex9AdJ/jvZA8ulvjzK1lo3rRVFfmd10lgjqAbDQM4ehR1',0,'2015-02-18 15:23:44','2015-02-18 16:19:32',1),(2,'user-2@dlayer.com','$6$rounds=5000$jks453yuyt55d$ZVEJgs2kNjxOxNEayqqoh2oJUiGbmxIKRqOTxVM05MP2YRcAjE9adCZfQBWCc.qe1nDjEM9.ioivNz3c/qyZ80',0,'2015-02-18 01:06:36','2015-02-18 01:07:22',1),(3,'user-3@dlayer.com','$6$rounds=5000$jks453yuyt55d$NYF6yCvxXplefx7nr8vDe4cUGBEFtd3G5vuJ2utfqvPwEf3dSgNXNTcGbFO6WrJSn21CXHgZwNOQHy691E/Rm.',0,'2015-02-18 01:07:31','2015-02-18 01:10:50',1);
...
insert  into `user_site_page_content_item`(`id`,`site_id`,`page_id`,`row_id`,`content_type`,`sort_order`) values (1,1,1,1,2,1),(2,1,1,1,2,2),(3,1,1,1,1,3),(4,1,1,2,2,1),(5,1,1,2,3,2),(6,2,2,3,2,1),(7,2,2,3,2,2),(8,2,2,3,1,3),(9,2,2,4,2,1),(10,2,2,4,3,2),(11,3,3,5,2,1),(12,3,3,5,2,2),(13,3,3,5,1,3),(14,3,3,6,2,1),(15,3,3,6,3,2);
...
insert  into `user_site_page_content_rows`(`id`,`site_id`,`page_id`,`div_id`,`sort_order`) values (1,1,1,2,1),(2,1,1,3,1),(3,2,2,6,1),(4,2,2,7,1),(5,3,3,10,1),(6,3,3,11,1),(7,1,1,4,1);
