...
insert  into `dlayer_module_tool_tab`(`id`,`module_id`,`tool_id`,`name`,`script`,`model`,`glyph`,`glyph_style`,`multi_use`,`edit_mode`,`default`,`sort_order`,`enabled`) values
    ...
    (NULL,4,1,'Page','page',NULL,'file',NULL,0,0,1,1,1),
    (NULL,4,1,'Help','help',NULL,'info-sign',NULL,0,0,0,3,1),
    (NULL,4,10,'Column','column',NULL,'align-justify',"transform: rotate(10deg);",0,0,1,1,1),
    (NULL,4,10,'Help','help',NULL,'info-sign',NULL,0,0,0,5,1),
    (NULL,4,3,'Add Column','add-column',NULL,'align-justify',"transform: rotate(10deg);",0,0,1,1,1),
    (NULL,4,3,'Help','help',NULL,'info-sign',NULL,0,0,0,2,1),
    (NULL,4,3,'Styles','styling','Styling','tint',NULL,1,1,0,2,1),
    (NULL,4,10,'Styles','styling','Styling','tint',NULL,1,0,0,4,1),
    (NULL,4,7,'Styles','styling','Styling','tint',NULL,1,0,0,2,1),
    (NULL,4,1,'Styles','styling','Styling','tint',NULL,1,0,0,2,1),
    (NULL,4,4,'Styling','styling','Styling','tint',NULL,1,1,0,2,1),
    (NULL,4,8,'Styling','styling','Styling','tint',NULL,1,1,0,2,1),
    (NULL,4,6,'Styling','styling','Styling','tint',NULL,1,1,0,2,1),
    ...
    (NULL,4,10,'Responsive','responsive','Responsive','equalizer',"transform: rotate(10deg);",1,0,0,3,1);
