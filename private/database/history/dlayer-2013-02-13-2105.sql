...
insert  into `dlayer_sessions`(`session_id`,`save_path`,`name`,`modified`,`lifetime`,`session_data`) values ('3ve8lpoaqrg39sei5lnlu5vej7','','PHPSESSID',1360789497,1440,'dlayer_session|a:2:{s:4:\"site\";i:1;s:8:\"template\";i:1;}dlayer_session_template|a:3:{s:4:\"tool\";s:1:\"7\";s:10:\"ribbon_tab\";s:1:\"7\";s:16:\"selected_element\";s:3:\"130\";}');
...
insert  into `user_site_template_div_sizes`(`id`,`template_id`,`div_id`,`width`,`height`,`design_height`) values (127,1,127,980,0,175),(128,1,128,980,0,375),(129,1,129,980,0,88),(130,1,130,980,0,87);
...
insert  into `user_site_template_divs`(`id`,`site_id`,`template_id`,`parent_id`,`sort_order`) values (127,1,1,0,1),(128,1,1,0,2),(129,1,1,127,1),(130,1,1,127,2);
