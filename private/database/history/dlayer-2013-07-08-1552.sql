/*
SQLyog Enterprise v11.13 (32 bit)
...
insert  into `user_settings_headings`(`id`,`site_id`,`heading_id`,`style_id`,`weight_id`,`decoration_id`,`size`,`hex`,`margin_top`,`margin_bottom`,`sort_order`,`enabled`) values (1,1,1,1,2,1,20,'#17365d',12,12,1,1),(2,1,2,1,2,1,18,'#366092',12,12,2,1),(3,1,3,1,2,1,16,'#366092',12,12,3,1),(4,1,4,1,2,1,14,'#366092',12,12,4,1),(5,1,5,2,2,1,14,'#366092',12,12,5,1),(6,1,6,1,1,1,12,'#366092',12,12,6,1),(7,1,7,2,1,1,12,'#366092',12,12,7,1);
