...
insert  into `dlayer_modules`(`id`,`name`,`button_name`,`title`,`description`,`icon`,`sort_order`,`enabled`) values (1,'template','Template','Template designer','Create the templates for your website, these defione the basic structure for your pages, you can create a template from scratch or copy an exisiting one.','template.png',1,1),(2,'widget','Widget','Widget designer','Create staic and dynamic reusable blocks, if you want to use an element on multiple pages it should proably be a widget, exmaples include your sites footer, menus and galleries.','widget.png',4,0),(3,'form','Forms','Forms builder','Create forms to gather information from your users. ','form.png',3,1),(4,'content','Content','Content manager','Create and manage the content for your website, you create a page by starting with a template or copying another page.','content.png',2,1),(5,'website','Website','Website manager','Create the relationships between the pages in your website.','website.png',5,0),(6,'question','Question','Question manager','Create quizzes or tests, supports multiple pages, text, video, image and audio based questions, multiple choice, single or free text answers, results are summed and calcuted based on your rules.','question.png',5,0);
...
insert  into `dlayer_sessions`(`session_id`,`save_path`,`name`,`modified`,`lifetime`,`session_data`) values ('t7kmtsluork0egiq1lg7c7rd73','','PHPSESSID',1379945148,1440,'__ZF|a:3:{s:14:\"dlayer_session\";a:1:{s:3:\"ENT\";i:1379948748;}s:22:\"dlayer_session_content\";a:1:{s:3:\"ENT\";i:1379945197;}s:23:\"dlayer_session_template\";a:1:{s:3:\"ENT\";i:1379948748;}}dlayer_session|a:2:{s:7:\"site_id\";i:1;s:9:\"module_id\";s:1:\"1\";}dlayer_session_content|a:5:{s:11:\"template_id\";i:3;s:7:\"page_id\";i:2;s:15:\"selected_div_id\";N;s:4:\"tool\";N;s:19:\"selected_content_id\";N;}dlayer_session_template|a:5:{s:11:\"template_id\";i:3;s:4:\"tool\";s:6:\"border\";s:6:\"div_id\";s:3:\"169\";s:10:\"tool_model\";s:6:\"Border\";s:3:\"tab\";s:8:\"advanced\";}');
...
insert  into `user_form_field_attributes`(`id`,`site_id`,`form_id`,`field_id`,`attribute_id`,`attribute`) values (11,1,1,1,1,'40'),(12,1,1,1,2,'255'),(13,1,1,2,3,'40'),(14,1,1,2,4,'2');
...
insert  into `user_form_fields`(`id`,`site_id`,`form_id`,`field_type_id`,`label`,`description`) values (1,1,1,1,'Test field 1','Testing the addition of a text field'),(2,1,1,2,'Test field 2','Testing the addition of a text area');
...
insert  into `user_site_page_content`(`id`,`site_id`,`page_id`,`div_id`,`content_type`,`sort_order`) values (4,1,2,169,2,1);
...
insert  into `user_site_page_content_heading`(`id`,`site_id`,`page_id`,`content_id`,`heading_id`,`heading`) values (1,1,2,4,1,'Test heading');
...
insert  into `user_site_template_div_sizes`(`id`,`site_id`,`template_id`,`div_id`,`width`,`height`,`design_height`) values (1,1,3,169,970,0,368),(2,1,3,170,980,0,130),(3,1,3,171,580,0,130),(4,1,3,172,400,0,130);
...
insert  into `user_site_template_divs`(`id`,`site_id`,`template_id`,`parent_id`,`sort_order`) values (169,1,3,0,1),(170,1,3,0,2),(171,1,3,170,1),(172,1,3,170,2);
