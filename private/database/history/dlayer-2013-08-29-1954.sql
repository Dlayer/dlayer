/*
SQLyog Enterprise v11.22 (32 bit)
...
insert  into `designer_css_font_families`(`id`,`name`,`description`,`css`,`sort_order`,`enabled`) values (1,'Helvetica','Helvetica, Arial, Nimbus Sans L','Helvetica, Arial, \"Nimbus Sans L\", sans-serif',1,1),(2,'Lucida Grande','Lucida Grande, Lucida Sans Unicode, Bitstream Vera Sans','\"Lucida Grande\", \"Lucida Sans Unicode\", \"Bitstream Vera Sans\", sans-serif',2,1),(3,'Georgia','Georgia, URW Bookman L, serif','Georgia, \"URW Bookman L\", serif',3,1),(4,'Corbel','Corbel, Arial, Helvetica, Nimbus Sans L, Liberation Sans','Corbel, Arial, Helvetica, \"Nimbus Sans L\", \"Liberation Sans\", sans-serif',4,1),(5,'Code','Consolas, Bitstream Vera Sans Mono, Andale Mono, Monaco, DejaVu Sans Mono, Lucida Console','Consolas, \"Bitstream Vera Sans Mono\", \"Andale Mono\", Monaco, \"DejaVu Sans Mono\", \"Lucida Console\", monospace',5,1),(6,'Verdana','Verdana, Geneva','Verdana, Geneva, sans-serif',6,1),(7,'Tahoma','Tahoma, Geneva','Tahoma, Geneva, sans-serif',7,1);
...
insert  into `user_settings_headings`(`id`,`site_id`,`heading_id`,`style_id`,`weight_id`,`decoration_id`,`size`,`color_hex`,`margin_top`,`margin_bottom`,`sort_order`,`enabled`) values (1,1,1,1,3,1,22,'#366092',12,12,1,1),(2,1,2,1,2,1,18,'#366092',12,12,2,1),(3,1,3,1,2,1,16,'#366092',12,12,3,1),(4,1,4,1,2,1,14,'#366092',12,12,4,1),(5,1,5,2,2,1,14,'#366092',12,12,5,1),(6,1,6,1,1,1,12,'#366092',12,12,6,1),(7,1,7,2,1,1,12,'#000000',12,12,7,1);
