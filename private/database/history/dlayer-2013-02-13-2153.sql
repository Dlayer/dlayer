...
insert  into `dlayer_sessions`(`session_id`,`save_path`,`name`,`modified`,`lifetime`,`session_data`) values ('3ve8lpoaqrg39sei5lnlu5vej7','','PHPSESSID',1360792258,1440,'dlayer_session|a:2:{s:4:\"site\";i:1;s:8:\"template\";i:1;}dlayer_session_template|a:3:{s:4:\"tool\";s:1:\"6\";s:10:\"ribbon_tab\";s:2:\"17\";s:16:\"selected_element\";s:3:\"145\";}');
...
insert  into `user_site_template_div_sizes`(`id`,`template_id`,`div_id`,`width`,`height`,`design_height`) values (145,1,145,980,0,100),(146,1,146,980,0,360),(147,1,147,378,0,360),(148,1,148,226,0,360),(149,1,149,376,0,360);
...
insert  into `user_site_template_divs`(`id`,`site_id`,`template_id`,`parent_id`,`sort_order`) values (145,1,1,0,1),(146,1,1,0,2),(147,1,1,146,1),(148,1,1,146,2),(149,1,1,146,3);
