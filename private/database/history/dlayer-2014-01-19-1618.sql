...
insert  into `dlayer_identities`(`id`,`identity`,`credentials`,`logged_in`,`last_login`,`last_action`,`enabled`) values (1,'user-1@dlayer.com','$6$rounds=5000$jks453yuyt55d$CZJCjaieFQghQ6MwQ1OUI5nVKDy/Fi2YXk7MyW2hcex9AdJ/jvZA8ulvjzK1lo3rRVFfmd10lgjqAbDQM4ehR1',1,'2014-01-19 15:34:28','2014-01-19 16:15:54',1),(2,'user-2@dlayer.com','$6$rounds=5000$jks453yuyt55d$ZVEJgs2kNjxOxNEayqqoh2oJUiGbmxIKRqOTxVM05MP2YRcAjE9adCZfQBWCc.qe1nDjEM9.ioivNz3c/qyZ80',0,'2013-11-17 19:48:08','2013-11-17 19:49:20',1),(3,'user-3@dlayer.com','$6$rounds=5000$jks453yuyt55d$NYF6yCvxXplefx7nr8vDe4cUGBEFtd3G5vuJ2utfqvPwEf3dSgNXNTcGbFO6WrJSn21CXHgZwNOQHy691E/Rm.',0,'2013-11-17 19:49:30','2013-11-17 19:50:44',1);
...
insert  into `user_form_field_attributes`(`id`,`site_id`,`form_id`,`field_id`,`attribute_id`,`attribute`) values (1,1,1,1,1,'40'),(2,1,1,1,2,'255'),(3,1,1,2,3,'40'),(4,1,1,2,4,'2');
...
insert  into `user_form_fields`(`id`,`site_id`,`form_id`,`field_type_id`,`label`,`description`) values (1,1,1,1,'Test field','This is a test field, description should appear below.'),(2,1,1,2,'This is another test field','Testing fields');
...
insert  into `user_settings_color_palettes`(`id`,`site_id`,`name`,`view_script`,`sort_order`) values (1,1,'Palette 1','palette-1',1),(2,1,'Palette 2','palette-2',2),(3,1,'Palette 3','palette-3',3),(4,2,'Palette 1','palette-1',1),(5,2,'Palette 2','palette-2',2),(6,2,'Palette 3','palette-3',3),(7,3,'Palette 1','palette-1',1),(8,3,'Palette 2','palette-2',2),(9,3,'Palette 3','palette-3',3),(10,5,'Palette 1','palette-1',1),(11,5,'Palette 2','palette-2',2),(12,5,'Palette 3','palette-3',3),(13,6,'Palette 1','palette-1',1),(14,6,'Palette 2','palette-2',2),(15,6,'Palette 3','palette-3',3),(16,7,'Palette 1','palette-1',1),(17,7,'Palette 2','palette-2',2),(18,7,'Palette 3','palette-3',3),(19,8,'Palette 1','palette-1',1),(20,8,'Palette 2','palette-2',2),(21,8,'Palette 3','palette-3',3),(22,9,'Palette 1','palette-1',1),(23,9,'Palette 2','palette-2',2),(24,9,'Palette 3','palette-3',3),(25,10,'Palette 1','palette-1',1),(26,10,'Palette 2','palette-2',2),(27,10,'Palette 3','palette-3',3),(28,11,'Palette 1','palette-1',1),(29,11,'Palette 2','palette-2',2),(30,11,'Palette 3','palette-3',3);
...
insert  into `user_settings_font_families`(`id`,`site_id`,`module_id`,`font_family_id`) values (1,1,4,5),(2,1,3,5),(3,2,4,1),(4,2,3,1),(6,3,4,1),(7,3,3,1);
...
insert  into `user_site_page_content`(`id`,`site_id`,`page_id`,`div_id`,`content_type`,`sort_order`) values (1,1,1,1,2,1),(2,1,1,1,1,2),(3,1,1,1,2,3);
...
insert  into `user_site_page_content_heading`(`id`,`site_id`,`page_id`,`content_id`,`heading_id`,`heading`,`width`,`margin_top`,`margin_bottom`,`margin_left`) values (1,1,1,1,1,'Test heading!',1015,12,12,5),(2,1,1,3,1,'Test heading',1015,12,12,5);
...
insert  into `user_site_page_content_text`(`id`,`site_id`,`page_id`,`content_id`,`width`,`padding`,`content`) values (1,1,1,2,980,20,'This is a test to see what is happening.');
...
insert  into `user_site_pages`(`id`,`site_id`,`template_id`,`name`,`title`) values (1,1,1,'Test page','Test page');
...
insert  into `user_site_template_div_sizes`(`id`,`site_id`,`template_id`,`div_id`,`width`,`height`,`design_height`) values (1,1,1,1,1020,0,350),(2,1,1,2,1020,0,350);
...
insert  into `user_site_template_divs`(`id`,`site_id`,`template_id`,`parent_id`,`sort_order`) values (1,1,1,0,1),(2,1,1,0,2);
...
insert  into `user_site_templates`(`id`,`site_id`,`name`) values (1,1,'Template 1'),(2,2,'Template 1'),(3,3,'Template 1'),(4,4,'Test'),(5,11,'Test template');
...
insert  into `user_sites`(`id`,`identity_id`,`name`) values (1,1,'Sample site 1'),(2,2,'Sample site 1'),(3,3,'Sample site 1'),(4,1,'Test'),(5,1,'Test website'),(6,1,'Test website 2'),(7,1,'Test website 3'),(8,1,'Test website 4'),(9,1,'Test website 5'),(10,1,'Test website 6'),(11,1,'Test website 7');
