...
insert  into `sites`(`id`,`name`) values (1,'Demo site 1'),(2,'Demo site 2');
...
insert  into `template_div_sizes`(`id`,`template_div_id`,`width`,`height`,`design_height`,`fixed_height`) values (1,1,328,500,500,0),(2,2,326,500,500,0),(3,3,326,500,500,0);
...
insert  into `template_divs`(`id`,`template_id`,`parent_id`,`sort_order`) values (1,1,0,1),(2,1,0,1),(3,1,0,1);
...
insert  into `templates`(`id`,`site_id`,`name`) values (1,1,'Template 1 site 1'),(2,1,'Template 1 site 2');
