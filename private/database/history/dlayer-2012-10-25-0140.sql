...
/*Table structure for table `template_div_background_colors` */

DROP TABLE IF EXISTS `template_div_background_colors`;

CREATE TABLE `template_div_background_colors` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
/*Data for the table `template_div_background_colors` */
