...
insert  into `dlayer_sessions`(`session_id`,`save_path`,`name`,`modified`,`lifetime`,`session_data`) values ('coh3paut2q0vgtunascr2rthb4','','PHPSESSID',1360598324,1440,'dlayer_session|a:2:{s:4:\"site\";i:1;s:8:\"template\";i:1;}dlayer_session_template|a:3:{s:4:\"tool\";s:1:\"6\";s:10:\"ribbon_tab\";s:2:\"18\";s:16:\"selected_element\";s:3:\"115\";}');
...
insert  into `user_site_template_div_sizes`(`id`,`template_id`,`div_id`,`width`,`height`,`design_height`) values (115,1,115,980,0,250),(116,1,116,980,0,250);
...
insert  into `user_site_template_divs`(`id`,`site_id`,`template_id`,`parent_id`,`sort_order`) values (115,1,1,0,1),(116,1,1,0,2);
