...
insert  into `dlayer_identities`(`id`,`identity`,`credentials`,`logged_in`,`last_login`,`last_action`,`enabled`) values (1,'user-1@dlayer.com','$6$rounds=5000$jks453yuyt55d$CZJCjaieFQghQ6MwQ1OUI5nVKDy/Fi2YXk7MyW2hcex9AdJ/jvZA8ulvjzK1lo3rRVFfmd10lgjqAbDQM4ehR1',1,'2013-11-14 01:32:32','2013-11-14 01:45:28',1),(2,'user-2@dlayer.com','$6$rounds=5000$jks453yuyt55d$ZVEJgs2kNjxOxNEayqqoh2oJUiGbmxIKRqOTxVM05MP2YRcAjE9adCZfQBWCc.qe1nDjEM9.ioivNz3c/qyZ80',0,'2013-11-13 12:54:09','2013-11-13 13:03:02',1),(3,'user-3@dlayer.com','$6$rounds=5000$jks453yuyt55d$NYF6yCvxXplefx7nr8vDe4cUGBEFtd3G5vuJ2utfqvPwEf3dSgNXNTcGbFO6WrJSn21CXHgZwNOQHy691E/Rm.',0,'0000-00-00 00:00:00','2013-11-13 11:15:03',1);
...
insert  into `user_site_pages`(`id`,`site_id`,`template_id`,`name`,`title`) values (2,1,4,'Page 1','Test design page 1'),(3,1,4,'Page 2','Test design page 2'),(4,1,3,'Page 3','Test design page 3');
...
insert  into `user_sites`(`id`,`identity_id`,`name`) values (1,1,'Sample site 1'),(2,1,'Sample site 2'),(3,2,'Sample site 1'),(4,2,'Sample site 2'),(5,3,'Sample site 1'),(6,3,'Sample site 2');
