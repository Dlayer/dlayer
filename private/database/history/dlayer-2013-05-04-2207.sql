...
insert  into `form_field_types`(`id`,`name`,`description`,`enabled`) values (1,'Text','A single line form input',1),(2,'Textarea','A multiple line for input',1);
...
CREATE TABLE `user_form_fields` (
  ...
  CONSTRAINT `user_form_fields_ibfk_1` FOREIGN KEY (`form_id`) REFERENCES `user_forms` (`id`),
  CONSTRAINT `user_form_fields_ibfk_2` FOREIGN KEY (`field_type_id`) REFERENCES `form_field_types` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
