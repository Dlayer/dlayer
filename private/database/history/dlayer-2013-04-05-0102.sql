...
insert  into `dlayer_development_log`(`id`,`change`,`added`) values (1,'Added a development log to DLayer to show changes to the application, two reasons, one to spur on my development, two, to show the public what I am adding.','2013-04-05 00:38:16'),(2,'Added a pagination view helper, update of my existing pagination view helper.','2013-04-05 00:38:52'),(3,'Another change','2013-04-05 00:44:22'),(4,'Another test change','2013-04-05 00:44:36'),(5,'Final test change to make sure pagination is working','2013-04-05 00:44:58');
