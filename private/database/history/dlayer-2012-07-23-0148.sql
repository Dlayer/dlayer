...
CREATE TABLE `ribbon_tabs` (
  ...
  CONSTRAINT `ribbon_tabs_ibfk_1` FOREIGN KEY (`tool_id`) REFERENCES `tools` (`id`),
  CONSTRAINT `ribbon_tabs_ibfk_2` FOREIGN KEY (`module_id`) REFERENCES `modules` (`id`)
...
CREATE TABLE `tools` (
  ...
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `action_name` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Method name in tools and ribbon controller',
  `script_name` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Script name in ribbon view folder',
  ...
  CONSTRAINT `tools_ibfk_1` FOREIGN KEY (`module_id`) REFERENCES `modules` (`id`) ON UPDATE CASCADE
