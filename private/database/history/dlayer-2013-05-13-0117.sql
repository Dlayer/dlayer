...
CREATE TABLE `user_form_fields` (
  ...
  KEY `field_type_id` (`field_type_id`),
  KEY `site_id` (`site_id`),
  CONSTRAINT `user_form_fields_ibfk_3` FOREIGN KEY (`site_id`) REFERENCES `user_sites` (`id`),
...
insert  into `user_form_fields`(`id`,`site_id`,`form_id`,`field_type_id`,`label`,`description`,`enabled`) values (1,1,1,1,'Name','Please enter your name.',1),(2,1,1,1,'Email','Please enter your email address.',1),(3,1,1,1,'Subject','Please enter the subject for your query.',1),(4,1,1,2,'Comment','Please enter your comment.',1);
