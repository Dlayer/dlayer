...
insert  into `dlayer_modules`(`id`,`name`,`button_name`,`title`,`description`,`icon`,`sort_order`,`enabled`) values (1,'template','Template','Template designer','Create the templates that define the basic structure of your pages.','template.png',1,1),(2,'widget','Widget','Widget designer','Create reusable blocks, if you want to use an element on multiple pages it should proably be a widget.','widget.png',4,0),(3,'form','Forms','Forms builder','Create forms to gather information from your users. ','form.png',3,1),(4,'content','Content','Content manager','Create and manage the content for your website, you create a page using a defined template.','content.png',2,1),(5,'website','Website','Website manager','Create the relationships between the pages in your website.','website.png',5,0);
...
insert  into `dlayer_sessions`(`session_id`,`save_path`,`name`,`modified`,`lifetime`,`session_data`) values ('icp9cb3ghpsftcsoufj5a9fic7','','PHPSESSID',1379378572,1440,'__ZF|a:4:{s:14:\"dlayer_session\";a:1:{s:3:\"ENT\";i:1379382172;}s:23:\"dlayer_session_template\";a:1:{s:3:\"ENT\";i:1379380684;}s:22:\"dlayer_session_content\";a:1:{s:3:\"ENT\";i:1379380687;}s:19:\"dlayer_session_form\";a:1:{s:3:\"ENT\";i:1379380900;}}dlayer_session|a:2:{s:7:\"site_id\";i:1;s:9:\"module_id\";s:1:\"5\";}dlayer_session_template|a:1:{s:11:\"template_id\";i:1;}dlayer_session_content|a:2:{s:11:\"template_id\";i:1;s:7:\"page_id\";i:1;}dlayer_session_form|a:1:{s:7:\"form_id\";i:1;}'),('t7kmtsluork0egiq1lg7c7rd73','','PHPSESSID',1379609217,1440,'__ZF|a:2:{s:14:\"dlayer_session\";a:1:{s:3:\"ENT\";i:1379612817;}s:23:\"dlayer_session_template\";a:1:{s:3:\"ENT\";i:1379612817;}}dlayer_session|a:2:{s:7:\"site_id\";i:1;s:9:\"module_id\";s:1:\"1\";}dlayer_session_template|a:3:{s:11:\"template_id\";i:1;s:4:\"tool\";N;s:6:\"div_id\";N;}');
...
insert  into `user_form_fields`(`id`,`site_id`,`form_id`,`field_type_id`,`label`,`description`) values (1,1,1,1,'Name','Please enter your name'),(2,1,1,1,'Email','Please enter your email address'),(3,1,1,2,'Comment','Please enter your comment'),(5,1,1,2,'Test field','Test field description'),(6,1,1,1,'Testing text field - Edit','Testing the see if the text field is added - Edit');
...
insert  into `user_settings_headings`(`id`,`site_id`,`heading_id`,`style_id`,`weight_id`,`decoration_id`,`size`,`color_hex`,`margin_top`,`margin_bottom`,`sort_order`) values (1,1,1,1,2,1,22,'#81A594',12,12,1),(2,1,2,1,2,1,18,'#81A594',12,12,2),(3,1,3,1,2,1,16,'#81A594',12,12,3),(4,1,4,1,2,1,14,'#81A594',12,12,4),(5,1,5,2,2,1,14,'#81A594',12,12,5),(6,1,6,1,1,1,12,'#81A594',12,12,6),(7,1,7,2,1,1,12,'#000000',12,12,7);
...
insert  into `user_site_page_content`(`id`,`site_id`,`page_id`,`template_id`,`div_id`,`content_type`,`sort_order`) values (1,1,1,1,163,1,2),(2,1,1,1,163,1,3),(3,1,1,1,163,2,1);
...
insert  into `user_site_page_content_heading`(`id`,`site_id`,`page_id`,`content_id`,`heading_id`,`heading`) values (1,1,1,3,2,'This is a test heading');
...
insert  into `user_site_pages`(`id`,`site_id`,`template_id`,`name`,`title`) values (1,1,2,'Home page','G3D Development Limited');
...
insert  into `user_site_template_div_background_colors`(`id`,`site_id`,`template_id`,`div_id`,`color_hex`) values (17,1,1,160,'#999999'),(19,1,1,159,'#f3f1df'),(20,1,1,162,'#336699'),(21,1,1,163,'#f3f1df');
...
insert  into `user_site_template_div_borders`(`id`,`site_id`,`template_id`,`div_id`,`position`,`style`,`width`,`color_hex`) values (13,1,1,163,'top','solid',2,'#000000'),(14,1,1,163,'right','solid',2,'#000000'),(15,1,1,163,'bottom','solid',2,'#000000'),(16,1,1,163,'left','solid',2,'#000000'),(25,1,1,161,'top','solid',5,'#000000'),(26,1,1,161,'right','solid',5,'#000000'),(27,1,1,161,'bottom','solid',5,'#000000'),(28,1,1,161,'left','solid',5,'#000000');
...
insert  into `user_site_template_div_sizes`(`id`,`site_id`,`template_id`,`div_id`,`width`,`height`,`design_height`) values (158,1,1,158,980,0,190),(159,1,1,159,980,0,380),(160,1,1,160,140,0,190),(161,1,1,161,830,0,180),(162,1,1,162,140,0,380),(163,1,1,163,836,0,376),(164,1,1,164,140,0,95),(165,1,1,165,140,0,95);
...
insert  into `user_site_templates`(`id`,`site_id`,`name`) values (1,1,'Template 1 site 1'),(2,1,'Template 2 site 1');
