...
insert  into `dlayer_module_tool_tabs`(`id`,`module_id`,`tool_id`,`name`,`script_name`,`multi_use`,`default`,`sort_order`,`enabled`) values (1,1,2,'Quick split','quick',0,1,1,1),(2,1,2,'Split with mouse','advanced',0,0,2,1),(3,1,2,'Help','help',0,0,3,1),(4,1,3,'Quick split','quick',0,1,1,1),(5,1,3,'Split with mouse','advanced',0,0,2,1),(6,1,3,'Help','help',0,0,3,1),(7,1,7,'Palette 1','palette-1',0,1,1,1),(8,1,7,'Palette 2','palette-2',0,0,2,1),(9,1,7,'Palette 3','palette-3',0,0,3,1),(10,1,7,'Set custom color','advanced',0,0,4,1),(11,1,7,'Help','help',0,0,5,1),(12,1,6,'Set custom size','advanced',0,0,5,1),(14,1,6,'Help','help',0,0,6,1),(15,1,6,'Expand','expand',1,1,1,1),(16,1,6,'Contract','contract',1,0,2,1),(17,1,6,'Adjust height','height',1,0,3,1),(20,1,8,'Set custom border','advanced',1,1,2,1),(21,1,8,'Help','help',0,0,3,1),(22,1,8,'Full','full',0,0,1,1);
...
insert  into `dlayer_sessions`(`session_id`,`save_path`,`name`,`modified`,`lifetime`,`session_data`) values ('c9bcl4k1r6p6s1aj2dk9clclc4','','PHPSESSID',1361380384,1440,'dlayer_session|a:3:{s:9:\"module_id\";s:1:\"1\";s:7:\"site_id\";i:1;s:11:\"template_id\";i:1;}dlayer_session_template|a:7:{s:7:\"tool_id\";s:1:\"8\";s:16:\"selected_element\";s:3:\"149\";s:9:\"tool_name\";s:6:\"border\";s:10:\"tool_model\";s:6:\"Border\";s:13:\"ribbon_tab_id\";s:2:\"20\";s:15:\"ribbon_tab_name\";N;s:10:\"ribbon_tab\";N;}');
...
insert  into `user_site_template_div_background_colors`(`id`,`template_id`,`div_id`,`hex`) values (6,1,145,'#336699'),(7,1,146,'#666666'),(8,1,147,'#666666'),(9,1,148,'#000000'),(10,1,149,'#f3f1df'),(11,1,152,'#666666');
...
insert  into `user_site_template_div_borders`(`id`,`template_id`,`div_id`,`position`,`style`,`width`,`hex`) values (5,1,145,'top','dashed',10,'#FF0000'),(6,1,145,'right','solid',10,'#000000'),(7,1,145,'bottom','solid',5,'#000000'),(8,1,145,'left','solid',10,'#000000'),(10,1,149,'top','solid',10,'#000000');
...
insert  into `user_site_template_div_sizes`(`id`,`template_id`,`div_id`,`width`,`height`,`design_height`) values (145,1,145,960,0,195),(146,1,146,980,0,390),(147,1,147,378,0,390),(148,1,148,226,0,390),(149,1,149,376,0,380),(150,1,150,226,0,180),(151,1,151,226,0,210),(152,1,152,480,0,195),(153,1,153,480,0,195);
...
insert  into `user_site_template_divs`(`id`,`site_id`,`template_id`,`parent_id`,`sort_order`) values (145,1,1,0,1),(146,1,1,0,2),(147,1,1,146,1),(148,1,1,146,2),(149,1,1,146,3),(150,1,1,148,1),(151,1,1,148,2),(152,1,1,145,1),(153,1,1,145,2);
