...
insert  into `user_site_page_content`(`id`,`site_id`,`page_id`,`div_id`,`content_type`,`sort_order`) values (4,1,2,169,2,1),(5,1,2,169,1,2),(6,1,2,169,2,3),(7,1,2,169,2,4);
...
insert  into `user_site_page_content_heading`(`id`,`site_id`,`page_id`,`content_id`,`heading_id`,`heading`,`margin_top`,`margin_bottom`) values (1,1,2,4,1,'Test heading',12,12),(2,1,2,6,1,'New test heading!',12,12),(3,1,2,7,2,'Another test heading',12,12);
