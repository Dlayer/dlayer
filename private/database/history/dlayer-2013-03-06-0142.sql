...
CREATE TABLE `user_settings_titles` (
  ...
  CONSTRAINT `user_settings_titles_ibfk_5` FOREIGN KEY (`decoration_id`) REFERENCES `designer_css_text_decoration` (`id`),
