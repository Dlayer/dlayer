...
insert  into `user_form_fields`(`id`,`site_id`,`form_id`,`field_type_id`,`label`,`description`,`enabled`) values (1,1,1,1,'Name','Please enter your name.',1),(2,1,1,1,'Email','Please enter your email address.',1),(3,1,1,1,'Subject','Please enter the subject for your query.',1);
