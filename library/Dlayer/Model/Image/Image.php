...
class Dlayer_Model_Image_Image extends Zend_Db_Table_Abstract
{
	...
	*/
	private function addToVersions($site_id, $library_id, $identity_id,
		$tool_id)
	{
		$sql = "INSERT INTO user_site_image_library_version
		...
		return $this->_db->lastInsertId('user_site_image_library_version');
	}
	...
	*/
	...
	{
		$sql = "INSERT INTO user_site_image_library_version_meta
	...
	*/
	...
	{
		$sql = "INSERT INTO user_site_image_library_link
	...
	*/
	private function versionMeta($site_id, $library_id, $version_id)
	{
		$sql = "SELECT extension, type, width, height, size
				FROM user_site_image_library_version_meta
				WHERE site_id = :site_id
