...
* @version $Id: Border.php 1042 2013-10-02 01:34:02Z Dean.Blackborough $
* @category Model
*/
class Dlayer_Model_Template_Div_Border extends Zend_Db_Table_Abstract
{
    ...
    */
    public function existingBorders($site_id, $template_id, $id)
    {
        $sql = "SELECT position, width
                FROM user_site_template_div_borders
    ...
    */
    ...
    {
        $sql = "UPDATE user_site_template_div_borders
    ...
    */
    ...
    {
        $sql = "DELETE FROM user_site_template_div_borders
                WHERE site_id = :site_id
                AND template_id = :template_id
                AND div_id = :div_id
                AND position = :position
    ...
    */
    ...
    $style, $width, $color_hex)
    {
        $sql = "INSERT INTO user_site_template_div_borders
