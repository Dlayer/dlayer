...
* @version $Id: BackgroundColor.php 1458 2014-01-25 01:10:15Z Dean.Blackborough $
* @category Model
*/
class Dlayer_Model_Template_Div_BackgroundColor extends Zend_Db_Table_Abstract
{
    ...
    */
    ...
    $color_hex)
    {
        $sql = "INSERT INTO user_site_template_div_background_colors
    ...
    */
    ...
    $color_hex)
    {
        $sql = "UPDATE user_site_template_div_background_colors
    ...
    */
    ...
    {
        $sql = "DELETE FROM user_site_template_div_background_colors
                WHERE site_id = :site_id
                AND template_id = :template_id
                AND div_id = :div_id";
        $stmt = $this->_db->prepare($sql);
