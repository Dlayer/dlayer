<?php
/**
* Content module text modifier model, contains all the methods used by 
* modifiers that act upon a text content item container
*
* @author Dean Blackborough <dean@g3d-development.com>
* @copyright G3D Development Limited
* @version $Id: Text.php 1774 2014-04-30 16:17:34Z Dean.Blackborough $
*/
class Dlayer_Model_Modifiers_Content_Text extends Zend_Db_Table_Abstract
{
    /**
    ...
    */
    public function itemDimensions($content_id, $site_id)
    {
        $sql = "SELECT width, padding
                FROM user_site_page_content_text
    ...
    */
    private function margins($content_id, $site_id, $content_type='text') 
    {
    ...
    /**
    * Set the new width for the text content item container, method should 
