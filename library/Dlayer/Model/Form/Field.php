...
* @version $Id: Field.php 1882 2014-06-01 15:01:22Z Dean.Blackborough $
*/
class Dlayer_Model_Form_Field extends Zend_Db_Table_Abstract
{
    ...
    */
    ...
    {
        $sql = "INSERT INTO user_site_form_field_attributes
                (site_id, form_id, field_id, attribute_id, attribute)
                VALUES
                (:site_id, :form_id, :field_id,
                (SELECT ffa.id
                 FROM designer_form_field_attributes ffa
                 JOIN designer_form_field_types fft
    ...
    */
    ...
    array $attributes, array $params, $field_type)
    {
        $sql = "UPDATE user_site_form_field_attributes
    ...
    */
    ...
    {
        $sql = "SELECT uff.id
                FROM user_site_form_fields uff
                JOIN designer_form_field_types fft ON uff.field_type_id = fft.id
    ...
    */
    public function field($id, $site_id, $form_id, $tool)
    {
        $sql = "SELECT uff.id, uff.label, uff.description
                FROM user_site_form_fields uff
                JOIN dlayer_module_tools dmt ON uff.tool_id = dmt.id 
                	AND dmt.tool = :tool 
                	AND dmt.module_id = 3 
                	AND dmt.enabled = 1 
    ...
    */
    public function assignedAttributes($id, $site_id, $form_id)
    {
        $sql = "SELECT uffa.field_id, uffa.attribute AS `value`,
                ...
                FROM user_site_form_field_attributes uffa
                JOIN designer_form_field_attributes ffa
                    ON uffa.attribute_id = ffa.id
                JOIN designer_form_field_attribute_types ffat
    ...
    */
    ...
    {
        $sql = "UPDATE user_site_form_fields 
    ...
    */
    private function sortOrder($site_id, $form_id, $field_type, $field_id) 
    {
        $sql = "SELECT usff.sort_order 
				FROM user_site_form_fields usff 
				JOIN designer_form_field_types fft 
    ...
    */
    ...
    array $params)
    {
        ...
        $sql = "INSERT INTO user_site_form_fields
                (site_id, form_id, field_type_id, tool_id, label, 
                description, 
                sort_order)
                VALUES
                (:site_id, :form_id, (SELECT id FROM designer_form_field_types
        ...
        return $this->_db->lastInsertId('user_site_form_fields');
    }
