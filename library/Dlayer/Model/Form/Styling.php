...
* @version $Id: Styling.php 1894 2014-06-03 00:10:11Z Dean.Blackborough $
*/
class Dlayer_Model_Form_Styling extends Zend_Db_Table_Abstract
{
    ...
    */
    ...
    $color_hex) 
    {
		$sql = "INSERT INTO user_site_form_field_row_background_colors 
    ...
    */
    ...
    {
		$sql = "UPDATE user_site_form_field_row_background_colors 
    ...
    */
    ...
    {
		$sql = "DELETE FROM user_site_form_field_row_background_colors 
				WHERE id = :id 
				LIMIT 1";
		$stmt = $this->_db->prepare($sql);
		$stmt->bindValue(':id', $id, PDO::PARAM_INT);
