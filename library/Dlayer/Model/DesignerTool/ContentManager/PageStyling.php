...
class Dlayer_Model_DesignerTool_ContentManager_PageStyling extends Zend_Db_Table_Abstract
{
     ...
     * @return array|false
     */
    public function getAttributeValue($site_id, $page_id, $attribute)
    {
        $sql = "SELECT 
                    `value` 
                FROM 
     ...
     */
    public function existingAttributeId($site_id, $page_id, $attribute)
    {
        $sql = "SELECT 
                    `id` 
                FROM 
     ...
     * @return boolean
     */
    public function addAttributeValue($site_id, $page_id, $attribute, $value)
    {
