...
/**
 * Column styling model class, tool 'models' interact with this to protect underlying structure
 *
 * @author Dean Blackborough <dean@g3d-development.com>
 * @copyright G3D Development Limited
 * @license https://github.com/Dlayer/dlayer/blob/master/LICENSE
 */
class Dlayer_Model_DesignerTool_ContentManager_ColumnStyling extends Zend_Db_Table_Abstract
{
    /**
     * Fetch an attribute that has been assigned to the requested column
     *
    ...
    /**
     * Check to see if an attribute exists on the requested column
     *
     * @param integer $site_id
     * @param integer $page_id
     * @param integer $id
    ...
    /**
     * Add a new attribute/value to the requested column
     *
     * @param integer $site_id
     * @param integer $page_id
     * @param integer $id
    ...
    {
        $sql = "INSERT INTO `user_site_column_styling`  
                (
                    `site_id`, 
                    `page_id`, 
                    `column_id`,
    ...
    {
        $sql = "DELETE FROM `user_site_column_styling` 
                WHERE 
                    `id` = :id 
                LIMIT 
                    1";
