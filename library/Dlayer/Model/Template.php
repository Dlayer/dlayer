...
* @version $Id: Template.php 1421 2014-01-20 16:23:02Z Dean.Blackborough $
* @category Model
*/
class Dlayer_Model_Template extends Zend_Db_Table_Abstract
{
    ...
    */
    ...
    {
		$sql = "INSERT INTO user_site_templates 
				(site_id, `name`) 
				VALUES 
				(:site_id, :name)";
		$stmt = $this->_db->prepare($sql);
    ...
    */
    ...
    {
		$sql = "UPDATE user_site_templates 
				SET `name` = :name 
				WHERE site_id = :site_id 
				AND id = :template_id";
		$stmt = $this->_db->prepare($sql);
