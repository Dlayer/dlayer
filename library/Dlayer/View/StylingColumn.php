...
/**
 * Styling view helper for the columns, calls child view helpers for each styling group
 *
 * @author Dean Blackborough <dean@g3d-development.com>
 * @copyright G3D Development Limited
 * @license https://github.com/Dlayer/dlayer/blob/master/LICENSE
 */
class Dlayer_View_StylingColumn extends Zend_View_Helper_Abstract
{
    /**
     ...
     *
     * @param array $styles Styles data array for all the columns that make up the page
     * @return Dlayer_View_StylingColumn
     */
    ...
    /**
     * Set the id of the column the view helper needs to generate styles for
     *
     * @param integer $id
     * @return Dlayer_View_StylingColumn
     */
    public function setColumn($id)
    {
        $this->resetParams();
