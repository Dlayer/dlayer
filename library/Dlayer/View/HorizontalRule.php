 ...
 */
class Dlayer_View_HorizontalRule extends Zend_View_Helper_Abstract
{
    /**
    ...
    private function render()
    {
        ...
        return '<hr class="' . $class . '" data-content-id="' .
            $this->view->escape($this->data['content_id']) . '" data-content-type="HorizontalRule" data-tool="HorizontalRule"' .
