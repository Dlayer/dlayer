...
*/
class Dlayer_View_BootstrapNavbarPreview extends Zend_View_Helper_Abstract
{
	/**
	...
	private function navbarItems()
	{
		...
		$html .= '
			<ul class="nav navbar-nav navbar-right">
				<li><a href="' . $this->preview_url . '" target="_blank"><span
					class="glyphicon glyphicon-new-window"
					aria-hidden="true"></span>
					Preview design (opens new window)</a></li>
			</ul>';
