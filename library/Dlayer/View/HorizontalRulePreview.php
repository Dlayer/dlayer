...
/**
 * Preview version of horizontal rule view helper
 *
 * @author Dean Blackborough <dean@g3d-development.com>
 * @copyright G3D Development Limited
 * @license https://github.com/Dlayer/dlayer/blob/master/LICENSE
 */
class Dlayer_View_HorizontalRulePreview extends Zend_View_Helper_Abstract
{
    /**
    ...
    {
        return '<hr ' . $this->view->stylingContentItem()->setContentItem($this->data['content_id']) . ' />';
    }
