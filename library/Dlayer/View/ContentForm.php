<?php
/**
* A form is wrapped in a container, the user defines the width and padding, 
* the layout settings and styes are all defined in the form builder
*
* @author Dean Blackborough <dean@g3d-development.com>
* @copyright G3D Development Limited
* @version $Id: ContentForm.php 1961 2014-06-17 00:01:52Z Dean.Blackborough $
*/
    ...
    */
    private function render()
    {
        ...
        if($this->selectable == TRUE) {
            ...
            $this->data['div_id'], $this->data['page_id'], 'form', 
            $mover_width);
        ...
        if($this->data['padding'] > 0) {
            $styles .= ' padding:' . 
            $this->view->escape($this->data['padding']) . 'px;';
        }

        $html .= '<div style="' . $styles . '" class="item c_item_'  . 
        $this->view->escape($this->data['content_id']) . ' form_' . 
        $this->view->escape($this->data['content_id']) . '" id="' . $id . 
        '">' . $this->data['form']->form() . '</div>';
