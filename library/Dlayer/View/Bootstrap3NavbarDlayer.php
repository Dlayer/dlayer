...
class Dlayer_View_Bootstrap3NavbarDlayer extends Zend_View_Helper_Abstract
{
		...
		$active_uri = '', $preview_uri = '', $signed_id = TRUE)
	{
		...
		$this->signed_in = $signed_id;

		// Custom id in case called multiple times within a view
