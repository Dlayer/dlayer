...
/**
 * Preset name element tool ribbon class
 *
 * @author Dean Blackborough <dean@g3d-development.com>
 * @copyright G3D Development Limited
 * @license https://github.com/Dlayer/dlayer/blob/master/LICENSE
 */
class Dlayer_DesignerTool_FormBuilder_PresetName_Ribbon extends Dlayer_Ribbon_Form
{
    /**
    ...
    public function viewData(array $tool)
    {
        ...
        return array(
            'form' => new Dlayer_DesignerTool_FormBuilder_PresetName_Form(
                $tool,
                $this->field_data,
                array()
            )
