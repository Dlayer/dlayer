...
/**
 * Form class for the email tool, allows the user to add an email field
 *
 * @author Dean Blackborough <dean@g3d-development.com>
 * @copyright G3D Development Limited
 * @license https://github.com/Dlayer/dlayer/blob/master/LICENSE
 */
class Dlayer_DesignerTool_FormBuilder_Email_Form extends Dlayer_Form_Form
{
	/**
	...
	{
		$this->setTitles('Add <small>Email field</small>', 'Edit <small>Email field</small>');
	...
	protected function addUserElements()
	{
		...
		$size->setLabel('<span class="glyphicon glyphicon-plus toggle" id="fgc-size" title="Expand for more" aria-hidden="true">
			</span> Display size');
		$size->setValue(40);
		...
		$maxlength->setLabel('<span class="glyphicon glyphicon-plus toggle" id="fgc-maxlength" title="Expand for more" aria-hidden="true">
			</span> Character limit');
		$maxlength->setValue(255);
		$maxlength->setAttribs(array(
			'maxlength' => 3,
