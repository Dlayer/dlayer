...
/**
 * Form for the date element tool, used by the add and edit actions
 *
 * @author Dean Blackborough
 * @copyright G3D Development Limited
 * @license https://github.com/Dlayer/dlayer/blob/master/LICENSE
 */
class Dlayer_DesignerTool_FormBuilder_Date_Form extends Dlayer_Form_Tool_Form
{
    /**
    ...
    public function init()
    {
        ...
        $this->addElementsToForm('date', 'Date element', $this->elements);
    ...
    protected function generateUserElements()
    {
        ...
        $label->setDescription('Please enter the label for the date element');
