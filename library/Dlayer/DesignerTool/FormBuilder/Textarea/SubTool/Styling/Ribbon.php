...
/**
 * Textarea element, styling sub tool ribbon class
 *
 * @author Dean Blackborough <dean@g3d-development.com>
 * @copyright G3D Development Limited
 * @license https://github.com/Dlayer/dlayer/blob/master/LICENSE
 */
class Dlayer_DesignerTool_FormBuilder_Textarea_SubTool_Styling_Ribbon extends Dlayer_Ribbon_Form
{
    /**
    ...
    public function viewData(array $tool)
    {
        ...
        return array(
            'form' => new Dlayer_DesignerTool_FormBuilder_Textarea_SubTool_Styling_Form(
                $tool,
                $this->field_data,
                array()
            ),
    ...
    protected function fieldData()
    {
        if ($this->field_data_fetched === false) {
            ...
            if ($this->tool['field_id'] !== null) {
                $model = new Dlayer_DesignerTool_FormBuilder_Textarea_SubTool_Styling_Model();
