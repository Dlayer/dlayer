...
/**
 * Form class for the textarea/styling sub tool, allows the user to control the styling for the field and row
 *
 * @author Dean Blackborough <dean@g3d-development.com>
 * @copyright G3D Development Limited
 * @license https://github.com/Dlayer/dlayer/blob/master/LICENSE
 */
class Dlayer_DesignerTool_FormBuilder_Textarea_SubTool_Styling_Form extends Dlayer_Form_Form
{
	/**
