 ...
 */
class Dlayer_DesignerTool_FormBuilder_Textarea_Tool extends Dlayer_DesignerTool_FormBuilder_Shared_Tool_Element
{
    /**
    ...
    protected function paramsValid(array $params)
    {
        ...
        if (strlen(trim($params['label'])) > 0 &&
            ...
            intval($params['rows']) > 0 &&
            intval($params['cols']) > 0) {
