...
/**
 * Form for the text element tool, used by the add and edit actions
 *
 * @author Dean Blackborough
 * @copyright G3D Development Limited
 * @license https://github.com/Dlayer/dlayer/blob/master/LICENSE
 */
class Dlayer_DesignerTool_FormBuilder_Text_Form extends Dlayer_Form_Tool_Form
{
    /**
    ...
    public function init()
    {
        ...
        $this->addElementsToForm('text', 'Text element', $this->elements);
    ...
    protected function generateUserElements()
    {
        ...
        $label->setDescription('Please enter the label for the text element');
        ...
        $description->setDescription('Please enter a description, this should indicate to the user what you are 
            expecting, for example, their name');
