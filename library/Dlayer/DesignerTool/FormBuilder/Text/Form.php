 ...
 */
class Dlayer_DesignerTool_FormBuilder_Text_Form extends Dlayer_Form_Form
{
	/**
	...
	protected function addUserElements()
	{
		...
		$label->setAttribs(array(
			'maxlength' => 255, 'placeholder' => 'e.g., Your name', 'class' => 'form-control input-sm',
		));
		...
		$description->setAttribs(array(
			'rows' => 2, 'cols' => 30, 'placeholder' => 'e.g., Please enter your name',
		...
		$placeholder->setAttribs(array(
			'maxlength' => 255, 'placeholder' => 'e.g., Joe Bloggs',
			'class' => 'form-control input-sm',
		));
