...
/**
 * Form for the preset email tool
 *
 * @author Dean Blackborough
 * @copyright G3D Development Limited
 * @license https://github.com/Dlayer/dlayer/blob/master/LICENSE
 */
class Dlayer_DesignerTool_FormBuilder_PresetEmail_Form extends Dlayer_Form_Tool_Form
{
    /**
    ...
    {
        $tool['name'] = 'Email'; // Override the tool
    ...
    protected function generateUserElements()
    {
        ...
        $label->setDescription('Click <mark>save</mark> to quickly add an email element to your form, all 
