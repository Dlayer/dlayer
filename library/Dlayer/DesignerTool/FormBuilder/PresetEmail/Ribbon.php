 ...
 */
class Dlayer_DesignerTool_FormBuilder_PresetEmail_Ribbon extends Dlayer_Ribbon_Module_Form
{
	/**
	...
	public function viewData($site_id, $form_id, $tool, $tab, $multi_use, $field_id = NULL, $edit_mode = FALSE)
	{
		...
		return array(
			'form' => new Dlayer_DesignerTool_FormBuilder_PresetEmail_Form('preset-email', 'text',
