...
/**
 * Styling sub tools for a row
 *
 * @author Dean Blackborough
 * @copyright G3D Development Limited
 * @license https://github.com/Dlayer/dlayer/blob/master/LICENSE
 */
class Dlayer_DesignerTool_ContentManager_Row_SubTool_Styling_Form extends Dlayer_Form_Tool_Content
{
    /**
    ...
    public function init()
    {
        ...
        $this->addElementsToForm('row_styling', 'Styling', $this->elements);
    ...
    protected function generateUserElements()
    {
        ...
        $background_color->setLabel('Row background color');
        $background_color->setDescription('Set the background colour for the selected row.');
