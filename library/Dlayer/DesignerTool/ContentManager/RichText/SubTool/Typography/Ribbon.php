 ...
 */
class Dlayer_DesignerTool_ContentManager_RichText_SubTool_Typography_Ribbon extends Dlayer_Ribbon_Content
{
    /**
    ...
    public function viewData(array $tool)
    {
        ...
        return array(
            'form' => new Dlayer_DesignerTool_ContentManager_RichText_SubTool_Typography_Form(
                $tool,
                $this->content_data,
