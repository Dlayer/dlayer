 ...
 */
class Dlayer_DesignerTool_ContentManager_RichText_SubTool_Delete_Ribbon extends Dlayer_Ribbon_Content
{
    /**
    ...
    public function viewData(array $tool)
    {
        ...
        return array(
            'form' => new Dlayer_DesignerTool_ContentManager_RichText_SubTool_Delete_Form(
                $tool,
                array(),
                0,
                array()
