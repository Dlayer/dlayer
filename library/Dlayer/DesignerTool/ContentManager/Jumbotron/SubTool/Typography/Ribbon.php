...
/**
 * Jumbotron content item data class
 *
 * @author Dean Blackborough <dean@g3d-development.com>
 * @copyright G3D Development Limited
 * @license https://github.com/Dlayer/dlayer/blob/master/LICENSE
 */
class Dlayer_DesignerTool_ContentManager_Jumbotron_SubTool_Typography_Ribbon extends Dlayer_Ribbon_Content
{
    /**
    ...
    public function viewData(array $tool)
    {
        ...
        return array(
            'form' => new Dlayer_DesignerTool_ContentManager_Jumbotron_SubTool_Typography_Form(
                $tool,
                $this->content_data,
    ...
    protected function contentData()
    {
        if ($this->content_fetched === false) {
            ...
            if ($this->tool['content_id'] !== null) {
                $model = new Dlayer_DesignerTool_ContentManager_Jumbotron_SubTool_Typography_Model();
