 ...
 */
class Dlayer_DesignerTool_ContentManager_Jumbotron_SubTool_Typography_Tool extends Dlayer_Tool_Content
{
    ...
    protected function fontFamily()
    {
        ...
        if ($id === false) {
            try {
                ...
                Dlayer_Helper::sendToInfoLog('Set font family for jumbotron content item: ' . $this->content_id .
