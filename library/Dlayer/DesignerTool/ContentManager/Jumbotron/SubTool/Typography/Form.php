 ...
 */
class Dlayer_DesignerTool_ContentManager_Jumbotron_SubTool_Typography_Form extends Dlayer_Form_Content
{
    /**
    ...
    public function init()
    {
        ...
        $this->addElementsToForm('jumbotron_typography', 'Typography', $this->elements);
