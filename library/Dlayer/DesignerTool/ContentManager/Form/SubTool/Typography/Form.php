...
/**
 * Typography sub tool for the form content item
 *
 * @author Dean Blackborough
 * @copyright G3D Development Limited
 * @license https://github.com/Dlayer/dlayer/blob/master/LICENSE
 */
class Dlayer_DesignerTool_ContentManager_Form_SubTool_Typography_Form extends Dlayer_Form_Content
{
    /**
    ...
    public function init()
    {
        ...
        $this->addElementsToForm('form_typography', 'Typography', $this->elements);
