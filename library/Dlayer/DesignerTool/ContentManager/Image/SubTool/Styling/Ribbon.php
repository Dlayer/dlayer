 ...
 */
class Dlayer_DesignerTool_ContentManager_Image_SubTool_Styling_Ribbon extends Dlayer_Ribbon_Content
{
    /**
    ...
    public function viewData(array $tool)
    {
        ...
        return array(
            'form' => new Dlayer_DesignerTool_ContentManager_Image_SubTool_Styling_Form(
                $tool,
                $this->content_data,
    ...
    protected function contentData()
    {
        if ($this->content_fetched === false) {
            ...
            if ($this->tool['content_id'] !== null) {
                $model_styling = new Dlayer_DesignerTool_ContentManager_Image_SubTool_Styling_Model();
