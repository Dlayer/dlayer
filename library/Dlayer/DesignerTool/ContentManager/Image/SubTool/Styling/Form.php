 ...
 */
class Dlayer_DesignerTool_ContentManager_Image_SubTool_Styling_Form extends Dlayer_Form_Content
{
    /**
    ...
    public function init()
    {
        ...
        $this->addElementsToForm('image_styling', 'Styling', $this->elements);
