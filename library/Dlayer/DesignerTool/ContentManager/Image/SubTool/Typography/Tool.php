 ...
 */
class Dlayer_DesignerTool_ContentManager_Image_SubTool_Typography_Tool extends Dlayer_Tool_Content
{
    ...
    protected function paramsValid(array $params)
    {
        ...
        $model = new Dlayer_DesignerTool_ContentManager_Image_SubTool_Typography_Model();
    ...
    protected function fontFamily()
    {
        ...
        if ($id === false) {
            try {
                ...
                Dlayer_Helper::sendToInfoLog('Set font family for image content item: ' . $this->content_id .
