...
/**
 * Heading content item data class
 *
 * @author Dean Blackborough <dean@g3d-development.com>
 * @copyright G3D Development Limited
 * @license https://github.com/Dlayer/dlayer/blob/master/LICENSE
 */
class Dlayer_DesignerTool_ContentManager_Heading_SubTool_Typography_Ribbon extends Dlayer_Ribbon_Content
{
    /**
    ...
    public function viewData(array $tool)
    {
        ...
        return array(
            'form' => new Dlayer_DesignerTool_ContentManager_Heading_SubTool_Typography_Form(
                $tool,
                $this->content_data,
