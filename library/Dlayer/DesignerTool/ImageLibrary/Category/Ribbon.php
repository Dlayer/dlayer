 ...
 */
class Dlayer_DesignerTool_ImageLibrary_Category_Ribbon extends Dlayer_Ribbon_Module_Image
{
	/**
	 ...
	 */
	public function viewData($site_id, $tool, $tab, $multi_use, $image_id = NULL, $version_id = NULL,
		$category_id = NULL,
		$subcategory_id = NULL, $edit_mode = FALSE)
	{
		$this->writeParams($site_id, $tool, $tab, $multi_use, $image_id,
			$version_id, $category_id, $subcategory_id, $edit_mode);

		return array(
			'form' => new Dlayer_DesignerTool_ImageLibrary_Category_Form( $this->existingData(), $this->edit_mode,
				$this->multi_use),
		);
	}
