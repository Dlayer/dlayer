<?php
/**
* Form for the styling tab of the image content item tool
* 
...
*/
class Dlayer_Form_Content_Styling_Image extends Dlayer_Form_Module_Content
{
	/**
	...
	*/
		...
		array $content_item, $edit_mode=FALSE, $multi_use=0, $options=NULL)
	{
		...
		$this->sub_tool_model = 'Styling_Image';
	...
	*/
	public function init()
	{
		...
		$legend = 'Styling <small>Set the styles for the image item</small>';
