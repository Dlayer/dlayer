<?php
/**
* Form for the styling tab of the jumbotron content item tool
* 
...
*/
class Dlayer_Form_Content_Styling_Jumbotron extends Dlayer_Form_Module_Content
{
	/**
	...
	*/
		...
		$multi_use=0, $options=NULL)
	{
		...
		$this->sub_tool_model = 'Styling_Jumbotron';
	...
	*/
	public function init()
	{
		...
		$legend = 'Styling <small>Set the styles for the jumbotron</small>';

		$this->addElementsToForm('jumbotron_styling', $legend, 
			$this->elements);
	...
	*/
	private function userElements() 
	{
		...
		$item_background_color->setLabel('Jumbotron background colour');
		$item_background_color->setDescription('Choose a background 
			colour for the jumbotron, to clear the background colour use the 
			clear link.');
