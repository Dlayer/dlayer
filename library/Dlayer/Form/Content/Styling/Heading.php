<?php
/**
* Form for the styling tab of the heading content item tool
* 
...
*/
class Dlayer_Form_Content_Styling_Heading extends 
Dlayer_Form_Module_Content
{
	...
	*/
		...
		array $content_item, $edit_mode=FALSE, $multi_use=0, $options=NULL)
	{
		...
		$this->sub_tool_model = 'Styling_Heading';
	...
	*/
	public function init()
	{
		...
		$legend = 'Styling <small>Set the styles for the heading item</small>';

		$this->addElementsToForm('heading_styling', $legend, $this->elements);
	...
	*/
	private function userElements() 
	{
		...
		$container_background_color->setLabel('Heading container background 
			colour');
		$container_background_color->setDescription('Choose a background 
			colour for the heading item content container, to clear the 
		...
		$item_background_color->setLabel('Heading item background colour');
		$item_background_color->setDescription('Choose a background 
			colour for the heading item, to clear the background colour use the 
			clear link.');
