<?php
/**
* Styling form for the heading content tool
* 
* Allows the user to define the background color for a heading content item
* 
...
class Dlayer_Form_Content_Styling_Heading extends Dlayer_Form_Module_Content
{
    ...
    */
    public function init()
    {
        ...
        $this->addElementsToForm('heading_styling', 'Container styling', 
        $this->elements);
    ...
    */
    private function userElements() 
    {
        ...
        heading container, to clear the background colour use the clear link.');
