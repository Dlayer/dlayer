<?php
/**
* Form for the size and position tab of the jumbotron content item tool
* 
...
*/
class Dlayer_Form_Content_Position_Jumbotron extends Dlayer_Form_Module_Content
{
	/**
	...
	*/
		...
		$multi_use=0, $options=NULL)
	{
		...
		$this->sub_tool_model = 'Position_Jumbotron';
	...
	*/
	public function init()
	{
		...
		$this->addElementsToForm('jumbotron_position', $legend, 
			$this->elements);
	...
	*/
	private function userElements() 
	{
		...
		$size->setDescription('Set the size for the jumbotron content item, 
			there are 12 columns to a row, the jumbotron item size can be set 
			to any value between 1 and 12');
