<?php
/**
* Form for the size and position tab of the image content item tool
* 
...
*/
class Dlayer_Form_Content_Position_Image extends Dlayer_Form_Module_Content
{
	/**
	...
	*/
		...
		array $content_item, $edit_mode=FALSE, $multi_use=0, $options=NULL)
	{
		...
		$this->sub_tool_model = 'Position_Image';
	...
	*/
	public function init()
	{
		...
		$this->addElementsToForm('image_position', $legend, $this->elements);
	...
	*/
	...
	{
		$this->elements['size'] = $this->sizeElement('image content item');
