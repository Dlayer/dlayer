...
* Edit site
* 
* Allows a user to edit the details for a web site
* 
* @author Dean Blackborough
* @copyright G3D Development Limited
* @version $Id: EditSite.php 1724 2014-04-13 15:12:59Z Dean.Blackborough $
*/
class Dlayer_Form_Site_EditSite extends Dlayer_Form_Module_App 
{
    ...
    */
    protected function validationRules() 
    {
        ...
        new Dlayer_Validate_SiteNameUnique($this->identity_id, $this->site_id));
    }
}