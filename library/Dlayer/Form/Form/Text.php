<?php
/**
 * Form class for the text tool, allows the user to add a text field
 *
 * @author Dean Blackborough <dean@g3d-development.com>
 * @copyright G3D Development Limited
 * @license https://github.com/Dlayer/dlayer/blob/master/LICENSE
 */
class Dlayer_Form_Form_Text extends Dlayer_Form_Form_Tool
{
	/**
	...
	*/
	protected function addUserElements()
	{
		...
		$label->setAttribs(array('maxlength'=>255, 'placeholder'=>'e.g., Your name', 'class'=>'form-control input-sm'));
		...
		$description->setAttribs(array('rows'=>2, 'cols'=>30, 'placeholder'=>'e.g., Please enter your name',
		...
		$placeholder->setAttribs(array('maxlength'=>255,'placeholder'=>'e.g., Joe Bloggs',
			'class'=>'form-control input-sm'));
		...
		$maxlength->setLabel('<span class="glyphicon glyphicon-plus toggle" id="fgc-maxlength" title="Expand for more" aria-hidden="true"></span> Character limit');
		$maxlength->setValue(255);
		$maxlength->setAttribs(array('maxlength'=>3, 'class'=>'form-control input-sm', 'min'=>0));
		$maxlength->setDescription('Maximum number of characters, defaults to 255 characters.');
