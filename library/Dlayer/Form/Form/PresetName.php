 ...
 */
class Dlayer_Form_Form_PresetName extends Dlayer_Form_Form_Tool
{
	/**
	...
	{		
		...
		$description->setAttribs(array('rows'=>2, 'cols'=>30, 'placeholder'=>'Please enter your name',
		...
		$placeholder->setAttribs(array('maxlength'=>255, 'placeholder'=>'Enter your name',
			'class'=>'form-control input-sm'));
