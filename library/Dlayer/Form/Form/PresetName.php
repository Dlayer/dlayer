<?php
/**
* Form for the name field tool
* 
* Allows the user to quickly add a name field to the form, the user simply 
...
class Dlayer_Form_Form_PresetName extends Dlayer_Form_Module_Form
{
	...
	*/
	public function init()
	{
		...
		$legend = 'Add <small>Name field</small>'; 
	...
	*/
	...
	{		
		...
		$label->setAttribs(array('maxlength'=>255, 
			'placeholder'=>'Your name', 'class'=>'form-control input-sm'));
		...
		$description->setAttribs(array('rows'=>2, 'cols'=>30, 
			'placeholder'=>'Please enter your name', 'class'=>'form-control input-sm'));
		$description->setDescription("Enter the description for the name field, 
		defaulted to 'Please enter your name'.");
		...
		$placeholder->setAttribs(array('maxlength'=>255, 
			'placeholder'=>'Enter your name', 'class'=>'form-control input-sm'));
		$placeholder->setDescription("Set the help text to display for the 
		name field, defaulted to 'Enter you name'.");
		...
		$size->setLabel('Size');
		$size->setValue(40);
		$size->setAttribs(array('maxlength'=>3, 'class'=>'form-control input-sm', 
			'min'=>0));
		$size->setDescription('Set the size of the name field in characters,
		...
		can be entered into the name field, we default to 255 characters.');
		...
		$submit->setLabel('Add name field');
