<?php
/**
* Styling sub tool form for the Form builder password tool, allows the user 
* to define the style values for the field row and field itself
* 
* @author Dean Blackborough
* @copyright G3D Development Limited
* @version $Id: Password.php 1824 2014-05-12 00:43:48Z Dean.Blackborough $
*/
class Dlayer_Form_Form_Styling_Password extends Dlayer_Form_Module_Form
{
	/**
    ...
    */
    ...
    $multi_use, $options=NULL)
    {
        ...
        $this->sub_tool_model = 'Styling_Password';
    ...
    */
    public function init()
    {
        ...
        $this->addElementsToForm('password_styling', 'Field styling', 
        $this->elements);
