<?php
/**
* Styling sub tool form for the Form builder text tool, allows the user to 
* define the style values for the field row and field itself
* 
* @author Dean Blackborough
* @copyright G3D Development Limited
* @version $Id: Text.php 1821 2014-05-10 00:33:46Z Dean.Blackborough $
*/
class Dlayer_Form_Form_Styling_Text extends Dlayer_Form_Module_Form
{
	/**
    ...
    */
    public function init()
    {
        ...
        $this->addElementsToForm('text_styling', 'Field styling', 
        $this->elements);
