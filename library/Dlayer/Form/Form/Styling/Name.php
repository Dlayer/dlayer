<?php
/**
* Styling sub tool form for the Form builder name tool, allows the user 
* to define the style values for the field row and field itself
* 
* @author Dean Blackborough
* @copyright G3D Development Limited
* @version $Id: Name.php 1826 2014-05-12 20:50:19Z Dean.Blackborough $
*/
class Dlayer_Form_Form_Styling_Name extends Dlayer_Form_Module_Form
{
	/**
    ...
    */
    ...
    $options=NULL)
    {
        ...
        $this->sub_tool_model = 'Styling_Name';
    ...
    */
    public function init()
    {
        ...
        $this->addElementsToForm('name_styling', 'Field styling', 
        $this->elements);
