...
* a module, in this case the template module
* 
* @author Dean Blackborough
* @copyright G3D Development Limited
*/
class Dlayer_Form_Settings_Content_BaseFont extends Dlayer_Form_Module_App 
{
	...
	*/
	...
	{        
		$this->setAction('/content/settings/base-font-family');
		...
		$this->addElementsToForm('font_families', 
			'Base font family <small>Default font for all content</small>',
			$this->elements);
