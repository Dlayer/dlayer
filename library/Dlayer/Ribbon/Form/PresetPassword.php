 ...
 */
class Dlayer_Ribbon_Form_PresetPassword extends Dlayer_Ribbon_Module_Form
{
	/**
	...
	public function viewData($site_id, $form_id, $tool, $tab, $multi_use, $field_id = NULL, $edit_mode = FALSE)
	{
		...
		return array(
			'form' => new Dlayer_Form_Form_PresetPassword('preset-password', 'password', '/form/process/tool/',
