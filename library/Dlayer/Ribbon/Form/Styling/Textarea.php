<?php
/**
* Styling sub tool ribbon data class for the textarea field tool
* 
...
* @version $Id: Textarea.php 1882 2014-06-01 15:01:22Z Dean.Blackborough $
*/
class Dlayer_Ribbon_Form_Styling_Textarea extends Dlayer_Ribbon_Module_Form
{
    /**
    ...
    */
    ...
    $multi_use, $field_id=NULL, $edit_mode=FALSE)
    {
        ...
        return array('form'=>new Dlayer_Form_Form_Styling_Textarea(
