<?php
/**
* Textarea field ribbon data class.
*
...
* @version $Id: Textarea.php 1894 2014-06-03 00:10:11Z Dean.Blackborough $
*/
class Dlayer_Ribbon_Form_Textarea extends Dlayer_Ribbon_Module_Form
{
    /**
    ...
    */
    ...
    {
        $this->writeParams($site_id, $form_id, $tool, $tab, 
        ...
        return array('form'=>new Dlayer_Form_Form_Textarea($this->form_id,
