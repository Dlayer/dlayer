<?php
/**
* Password field ribbon data class.
*
...
* @version $Id: Password.php 1894 2014-06-03 00:10:11Z Dean.Blackborough $
*/
class Dlayer_Ribbon_Form_Password extends Dlayer_Ribbon_Module_Form
{
    /**
    ...
    */
    ...
    $field_id=NULL, $edit_mode=FALSE)
    {
        ...
        return array('form'=>new Dlayer_Form_Form_Password($this->form_id,
