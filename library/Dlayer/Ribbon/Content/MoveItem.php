<?php
/**
* Move content item data class, returns the form for the tool tab view script
*
* @author Dean Blackborough <dean@g3d-development.com>
* @copyright G3D Development Limited
*/
class Dlayer_Ribbon_Content_MoveItem extends Dlayer_Ribbon_Module_Content
{
	/**
	...
	*/
		...
		$multi_use, $edit_mode=FALSE, $content_row_id=NULL, $content_id=NULL)
	{
		...
		return array('form'=>new Dlayer_Form_Content_MoveItem($this->page_id,
	...
	*/
	...
	{
		return array('id'=>$this->content_id);
	}
}