 ...
 *
 * @todo Need to extend a base class when we have it working again
...
{
	/**
	 * Fetch the view data for the tool tab, contains an index with the form and another with the data required by the
