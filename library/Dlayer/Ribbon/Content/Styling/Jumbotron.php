<?php
/**
* Jumbotron content item styling tool tab, returns the form for the view tab
* view script populated with the current values
*
* @author Dean Blackborough <dean@g3d-development.com>
* @copyright G3D Development Limited
*/
class Dlayer_Ribbon_Content_Styling_Jumbotron extends 
Dlayer_Ribbon_Module_Content
{
	...
	*/
		...
		$multi_use, $edit_mode=FALSE, $content_row_id=NULL, $content_id=NULL)
	{
		...
		return array('form'=>new Dlayer_Form_Content_Styling_Jumbotron(
	...
	*/
	...
	/**
	* Fetch the background color for thge jumbotron
	* 
