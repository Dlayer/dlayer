<?php
/**
* Heading content item tool position tab data class, returns the form for the 
...
*/
class Dlayer_Ribbon_Content_Position_Heading extends 
Dlayer_Ribbon_Module_Content
{
    /**
    * Data method for the heading tool position tab, returns the form 
    ...
    */
    protected function existingData()
    {
    	...
    	$this->div_id, $this->content_id, 'heading');
    ...
    */
    private function contentContainerWidth() 
    {
    	...
    	if($this->content_id != NULL) {
			...
			$dimensions = $model_content_heading->boxDimensions(
			$this->content_id, $this->site_id, $this->page_id, $this->div_id);
			
			$width = intval($dimensions['width']) + 
			intval($dimensions['padding_left']);
    	}
