...
class Dlayer_Session_Content extends Zend_Session_Namespace 
{
	...
	* 
	* By default the id of any previously selected content item is cleared 
	* when a content row is selected
	* 
	* @param integer $id
	* @param boolean $clear_content_id Clear any previously set content ids
	* @return void
	*/
	public function setContentRowId($id, $clear_content_id=TRUE) 
	{
