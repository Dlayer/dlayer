...
*/
class Dlayer_Image_LibraryResizer_Png extends Dlayer_Image_LibraryResizer 
{
    ...
    */
    ...
    $maintain_aspect=TRUE, $quality)
    {
        ...
        parent::__construct($width, $height, $canvas_color, 
    ...
    */
    ...
    {
        return imagepng($this->canvas, $this->dest_path . $this->dest_file . 
