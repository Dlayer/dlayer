...
*/
class Dlayer_Image_LibraryResizer_Gif extends Dlayer_Image_LibraryResizer 
{
    ...
    */
    ...
    {
        return imagegif($this->canvas, $this->dest_path . $this->dest_file . 
        $this->extension, $this->file);
    }
}