<?php
/**
* Add or edit the position values for the form content container, manages the 
* margin values
*
...
*/
class Dlayer_Tool_Content_Position_ImportForm extends Dlayer_Tool_Module_Content
{
    ...
    */
    ...
    $div_id)
    {
        ...
        $model_page_content_form = new Dlayer_Model_Page_Content_Items_Form();
        $box_dimensions = $model_page_content_form->boxDimensions(
        ...
        if($box_dimensions != FALSE) {
			...
			($box_dimensions['padding'] * 2) + intval($params['left']) 
			+ intval($params['right']);
        }
