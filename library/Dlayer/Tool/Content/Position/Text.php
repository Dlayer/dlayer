<?php
/**
* Add or edit the position values for the text content container, manages the 
* margin values
*
* @author Dean Blackborough <dean@g3d-development.com>
* @copyright G3D Development Limited
* @version $Id: Text.php 1861 2014-05-27 11:30:18Z Dean.Blackborough $
*/
class Dlayer_Tool_Content_Position_Text extends Dlayer_Tool_Module_Content
{
    ...
    */
    ...
    $div_id)
    {
        ...
        $model_page_content_text = new Dlayer_Model_Page_Content_Items_Text();
        $box_dimensions = $model_page_content_text->boxDimensions(
