<?php
/**
* Add or edit the styling for an imported form container, user can define the 
* background color.
* 
...
*/
class Dlayer_Tool_Content_Styling_ImportForm extends Dlayer_Tool_Module_Content
{
