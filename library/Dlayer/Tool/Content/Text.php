<?php
/**
* Add or edit a text content block, manages both the base content data for
* a content item and the specific data for the text item
*
...
class Dlayer_Tool_Content_Text extends Dlayer_Tool_Module_Content
{
    ...
    /**
    * Add a new text content block or edit the selected text content block.
    * This method uses the params array for the request, this data will have
    * alrteady been validated and prepared so the process method can just
    * process the request
    *
