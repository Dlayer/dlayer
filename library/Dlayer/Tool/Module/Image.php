...
abstract class Dlayer_Tool_Module_Image extends Dlayer_Tool 
{
    ...
    */
    abstract public function process($site_id, $category_id=NULL, 
    $sub_category_id=NULL, $image_id=NULL);
    ...
    * @param integer|NULL $image_id If in edit image mode the id of the image 
    *                               being edited
    * @return integer Id of the item being managed, image. category or sub 
    *                 category
    */
    abstract public function autoProcess($site_id, $category_id, 
    $sub_category_id, $image_id=NULL);
