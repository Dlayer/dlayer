<?php
/**
* Add or edit a name field, manages both the field and all the attributes
*
* @author Dean Blackborough <dean@g3d-development.com>
* @copyright G3D Development Limited
* @version $Id: Name.php 1738 2014-04-17 15:44:36Z Dean.Blackborough $
*/
class Dlayer_Tool_Form_Name extends Dlayer_Tool_Module_Form
{
	...
	/**
	* Add a new name field or edit the selected name field. Uses the data in
	...
	*/
	...
	/**
	* Add the name field and all the field attributes
	*
	...
	*/
	private function addFormField($site_id, $form_id)
	{
		...
		$session_form->setTool('text');

		return $insert_id;
	}

	/**
	* Edit the name field and all the field attributes
	*
	* @param integer $site_id
	* @param integer $form_id
