<?php
/**
* Styling sub tool for the text field input, allows the user to style the 
* row and field
*
...
*/
class Dlayer_Tool_Form_Styling_Text extends Dlayer_Tool_Module_Form
{
	protected $tool = 'text';
