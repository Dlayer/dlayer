<?php
/**
* Styling sub tool for the name field input, allows the user to style the 
* row and field
*
* @author Dean Blackborough <dean@g3d-development.com>
* @copyright G3D Development Limited
* @version $Id: Name.php 1861 2014-05-27 11:30:18Z Dean.Blackborough $
*/
class Dlayer_Tool_Form_Styling_Name extends Dlayer_Tool_Module_Form
{
    /**
