...
dlayerDesigner = {
    ...
    {
        $("a.expand-ribbon").click(
            function ()
            {
                if ($(this).hasClass('expanded') === true) {
                    $(this).removeClass('expanded');
                    $('.designer-left').removeClass('col-lg-6').addClass('col-lg-9');
                    $('.designer-right').removeClass('col-lg-6').addClass('col-lg-3');
                    $(this).find('span').removeClass('glyphicon-indent-left').addClass('glyphicon-indent-right');
                } else {
                    $(this).addClass('expanded');
                    $('.designer-left').removeClass('col-lg-9').addClass('col-lg-6');
                    $('.designer-right').removeClass('col-lg-3').addClass('col-lg-6');
                    $(this).find('span').removeClass('glyphicon-indent-right').addClass('glyphicon-indent-left');
                }
            }
        );
    }
